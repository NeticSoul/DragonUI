...
NP.const = {
    ...
    RETAIL_NAME_FONT_HEIGHT = 9.6, -- Modern (NewEra): retail's 12px name/health text at the Small plate scale 0.8
    RETAIL_CAST_FONT_HEIGHT = 8, -- Modern (NewEra): retail's 10px cast text at the Small plate scale 0.8
    NAME_TEXT_GAP = 2, -- space between the name and the health text sharing its line
    DEBUFF_HOST_OFFSET_Y = 2,
    DEBUFF_HOST_OFFSET_Y_OVERLAY = 1, -- name inside the bar: icons rest on the border, 1px above the bar
