...
L["New Loadout"] = "Neue Talentvorlage"
L["Starter Build"] = "Anfängervorlage"
L["Right-click: Rename / Delete"] = "Rechtsklick: Umbenennen / Löschen"
L["Click: Apply build"] = "Klick: Vorlage anwenden"
L["Delete loadout '%s'? This cannot be undone."] = "Talentvorlage „%s“ löschen? Dies kann nicht rückgängig gemacht werden."
L["Loadouts"] = "Talentvorlagen"
L["Post Link"] = "Link senden"
L["Save and apply this shared build:"] = "Diese geteilte Vorlage speichern und anwenden:"
L["Talent loadout export (Ctrl+C to copy):"] = "Export der Talentvorlage (Strg+C zum Kopieren):"
L["Accept"] = "Übernehmen"
L["Selection Settings"] = "Auswahloptionen"
L["Name this imported loadout:"] = "Diese importierte Vorlage benennen:"
L["Paste a talent build string (Ctrl+V):"] = "Talent-Codestring einfügen (Strg+V):"
L["Name this loadout (saves your current spec):"] = "Diese Vorlage benennen (speichert deine aktuelle Spezialisierung):"
L["Cannot apply loadout right now."] = "Die Talentvorlage kann derzeit nicht angewendet werden."
L["%d points staged on talent group %d. Click \"Apply Changes\" to commit."] = "%d Punkte in Talentgruppe %d vorgemerkt. Zum Übernehmen auf „Änderungen anwenden“ klicken."
L["%d points conflict with this spec (need a respec); %d staged."] = "%d Punkte kollidieren mit dieser Spezialisierung (Neuwahl nötig); %d vorgemerkt."
L["0 points staged. No unspent points, or this spec is already set."] = "0 Punkte vorgemerkt. Keine ungenutzten Punkte oder diese Spezialisierung ist bereits gesetzt."
