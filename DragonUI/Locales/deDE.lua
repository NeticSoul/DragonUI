...
L["World map module disabled: %s replaces the same map frame."] = "Weltkarten-Modul deaktiviert: %s ersetzt denselben Kartenrahmen."
L["Cursor"] = "Cursor"
...
-- Talents
L["Talents"] = "Talente"
L["Retail-style talent window"] = "Modernes Talentfenster"
L["points available"] = "Punkte verfügbar"
L["Search talents"] = "Talente suchen"
L["Rename specialization"] = "Spezialisierung umbenennen"
L["Glyph options"] = "Glyphenoptionen"
L["Toggle slot name labels and the active-effects list."] = "Slot-Name-Labels und die Liste der aktiven Effekte ein-/ausblenden."
...
L["None active."] = "Keine aktiv."
L["Delete loadout '%s'? This cannot be undone."] = "Talentvorlage „%s“ löschen? Dies kann nicht rückgängig gemacht werden."
L["Rename this specialization (max %d characters):"] = "Diese Spezialisierung umbenennen (max. %d Zeichen):"
L["Apply Changes"] = "Änderungen übernehmen"
L["Save Build"] = "Build speichern"
L["Undo the last point"] = "Letzten Punkt rückgängig machen"
L["Exit Editor"] = "Editor verlassen"
L["Back to your live talents. Saved builds keep every change."] = "Zurück zu deinen aktuellen Talenten. Gespeicherte Builds behalten jede Änderung."
L["Talent Builds"] = "Talent-Builds"
L["Design and save builds offline — no points needed."] = "Builds ohne Punkte planen und speichern."
L["New build"] = "Neuer Build"
L["New build from current talents"] = "Neuer Build aus aktuellen Talenten"
L["Copy code"] = "Code kopieren"
L["Post link in chat"] = "Link im Chat posten"
L["Asking %s for the build…"] = "Frage %s nach dem Build…"
L["%s didn't answer — they may be offline or not running DragonUI."] = "%s hat nicht geantwortet – vielleicht offline oder ohne DragonUI."
L["Import code…"] = "Code importieren…"
L["Load onto character"] = "Auf Charakter laden"
L["Edit"] = "Bearbeiten"
L["Rename"] = "Umbenennen"
L["Editing: %s"] = "Bearbeitung: %s"
L["Level Required: %d"] = "Benötigte Stufe: %d"
L["(auto)"] = "(auto)"
L["%d / %d points · Level %d"] = "%d / %d Punkte · Stufe %d"
L["In this build: rank %d / %d"] = "In diesem Build: Rang %d / %d"
L["Not in this build"] = "Nicht in diesem Build"
L["This build isn't saved — exit and discard it?"] = "Dieser Build ist nicht gespeichert – verlassen und verwerfen?"
L["Discard"] = "Verwerfen"
L["This build conflicts with talents you've already spent.\n\nVisit your class trainer to reset your talents, then load the build again."] = "Dieser Build steht im Konflikt mit bereits verteilten Talenten.\n\nSetze deine Talente bei deinem Klassenlehrer zurück und lade den Build erneut."
L["Character already matches this build."] = "Der Charakter entspricht bereits diesem Build."
L["This build needs %d points; you have %d unspent."] = "Dieser Build benötigt %d Punkte; du hast %d unverteilte."
L["Build staged — click Apply Changes to learn it."] = "Build vorgemerkt – klicke auf „Änderungen übernehmen“, um ihn zu lernen."
L["Name this build:"] = "Diesen Build benennen:"
L["Level required for this build (10-%d).\nLeave blank for automatic (grows with the build)."] = "Benötigte Stufe für diesen Build (10-%d).\nLeer lassen für automatisch (wächst mit dem Build)."
L["Level clamped to %d (build size / level cap)."] = "Stufe auf %d begrenzt (Buildgröße / Stufenobergrenze)."
L["Paste a DragonUI talent code:"] = "DragonUI-Talentcode einfügen:"
L["Talent import: %s"] = "Talentimport: %s"
L["Talent build code (Ctrl+C to copy):"] = "Talent-Build-Code (Strg+C zum Kopieren):"
L["Build saved: %s"] = "Build gespeichert: %s"
L["Build saved for %s: %s"] = "Build für %s gespeichert: %s"
L["Build sent (%s). Only DragonUI players will see it."] = "Build gesendet (%s). Nur DragonUI-Spieler sehen ihn."
L["%s shared a talent build with you:"] = "%s hat einen Talent-Build mit dir geteilt:"
L["Imported"] = "Importiert"
L["couldn't read a talent code"] = "kein Talentcode erkannt"
L["talent data unavailable"] = "Talentdaten nicht verfügbar"
L["that build doesn't fit your talent trees"] = "dieser Build passt nicht zu deinen Talentbäumen"
L["Import to My Profiles"] = "In meine Profile importieren"
L["Save this build to your talent profiles."] = "Diesen Build in deinen Talentprofilen speichern."
