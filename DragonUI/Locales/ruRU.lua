...
L["Dedicated window for your mounts and companion pets, opened from the micro menu"] = "Отдельное окно для транспорта и спутников, открывается из микроменю"
...
L["Summon Random Favorite"] = "Призвать случайное избранное"
L["Picks a favorite you can actually use here, or any of them if none are favorited."] = "Выбирает избранное, пригодное здесь, или любое, если избранных нет."
