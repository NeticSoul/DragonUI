...
L["Rename this specialization (letters only, max %d):"] = "Переименовать эту специализацию (только буквы, максимум %d):"
L["Remove this glyph?"] = "Удалить этот символ?"
L["Activate"] = "Активировать"
L["ACTIVE EFFECTS"] = "АКТИВНЫЕ ЭФФЕКТЫ"
L["MAJOR GLYPHS"] = "БОЛЬШИЕ СИМВОЛЫ"
L["MINOR GLYPHS"] = "МАЛЫЕ СИМВОЛЫ"
L["points spent"] = "потрачено очков"
...
L["New Loadout"] = "Новая сборка"
L["Starter Build"] = "Базовая сборка"
L["Right-click: Rename / Delete"] = "ПКМ: переименовать / удалить"
L["Click: Apply build"] = "ЛКМ: применить сборку"
L["Delete loadout '%s'? This cannot be undone."] = "Удалить сборку «%s»? Это действие необратимо."
L["Loadouts"] = "Сборки"
L["Post Link"] = "Отправить ссылку"
L["Save and apply this shared build:"] = "Сохранить и применить эту общую сборку:"
L["Talent loadout export (Ctrl+C to copy):"] = "Экспорт сборки талантов (Ctrl+C для копирования):"
L["Accept"] = "Принять"
L["Selection Settings"] = "Настройки выбора"
L["Name this imported loadout:"] = "Назовите импортированную сборку:"
L["Paste a talent build string (Ctrl+V):"] = "Вставьте строку сборки талантов (Ctrl+V):"
L["Name this loadout (saves your current spec):"] = "Назовите эту сборку (сохраняет текущую специализацию):"
L["Cannot apply loadout right now."] = "Невозможно применить сборку прямо сейчас."
L["%d points staged on talent group %d. Click \"Apply Changes\" to commit."] = "%d очков отложено в группе талантов %d. Нажмите «Применить изменения», чтобы подтвердить."
L["%d points conflict with this spec (need a respec); %d staged."] = "%d очков конфликтуют с этой специализацией (нужен респек); %d отложено."
L["0 points staged. No unspent points, or this spec is already set."] = "Отложено 0 очков. Нет неиспользованных очков, или эта специализация уже настроена."
