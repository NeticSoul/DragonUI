...
-- Talents
L["Talents"] = "Таланты"
L["Retail-style talent window"] = "Окно талантов в современном стиле"
L["points available"] = "доступно очков"
L["Search talents"] = "Поиск талантов"
L["Rename specialization"] = "Переименовать специализацию"
L["Glyph options"] = "Параметры символов"
L["Toggle slot name labels and the active-effects list."] = "Переключить подписи названий слотов и список активных эффектов."
L["Show glyph names"] = "Показывать названия символов"
L["Show glyph effects"] = "Показывать эффекты символов"
L["NO ACTIVE EFFECTS"] = "НЕТ АКТИВНЫХ ЭФФЕКТОВ"
L["None active."] = "Активных нет."
L["Delete loadout '%s'? This cannot be undone."] = "Удалить сборку «%s»? Это действие необратимо."
L["Rename this specialization (max %d characters):"] = "Переименовать эту специализацию (не более %d символов):"
L["Apply Changes"] = "Применить изменения"
L["Save Build"] = "Сохранить сборку"
L["Undo the last point"] = "Отменить последнее очко"
L["Exit Editor"] = "Выйти из редактора"
L["Back to your live talents. Saved builds keep every change."] = "Вернуться к текущим талантам. Сохранённые сборки сохраняют все изменения."
L["Talent Builds"] = "Сборки талантов"
L["Design and save builds offline — no points needed."] = "Создавайте и сохраняйте сборки, не тратя очки."
L["New build"] = "Новая сборка"
L["New build from current talents"] = "Новая сборка из текущих талантов"
L["Copy code"] = "Копировать код"
L["Post link in chat"] = "Опубликовать ссылку в чате"
L["Asking %s for the build…"] = "Запрашиваем сборку у %s…"
L["%s didn't answer — they may be offline or not running DragonUI."] = "%s не ответил — возможно, не в сети или не использует DragonUI."
L["Import code…"] = "Импортировать код…"
L["Load onto character"] = "Загрузить на персонажа"
L["Edit"] = "Изменить"
L["Rename"] = "Переименовать"
L["Editing: %s"] = "Редактирование: %s"
L["Level Required: %d"] = "Требуемый уровень: %d"
L["(auto)"] = "(авто)"
L["%d / %d points · Level %d"] = "%d / %d очков · Уровень %d"
L["In this build: rank %d / %d"] = "В этой сборке: %d / %d"
L["Not in this build"] = "Нет в этой сборке"
L["This build isn't saved — exit and discard it?"] = "Эта сборка не сохранена. Выйти и отменить её?"
L["Discard"] = "Отменить"
L["This build conflicts with talents you've already spent.\n\nVisit your class trainer to reset your talents, then load the build again."] = "Эта сборка конфликтует с уже распределёнными талантами.\n\nСбросьте таланты у учителя вашего класса и загрузите сборку снова."
L["Character already matches this build."] = "Персонаж уже соответствует этой сборке."
L["This build needs %d points; you have %d unspent."] = "Этой сборке нужно %d очков; у вас %d нераспределённых."
L["Build staged — click Apply Changes to learn it."] = "Сборка подготовлена — нажмите «Применить изменения», чтобы изучить её."
L["Name this build:"] = "Название сборки:"
L["Level required for this build (10-%d).\nLeave blank for automatic (grows with the build)."] = "Требуемый уровень для этой сборки (10-%d).\nОставьте пустым для автоматического (растёт вместе со сборкой)."
L["Level clamped to %d (build size / level cap)."] = "Уровень ограничен до %d (размер сборки / максимальный уровень)."
L["Paste a DragonUI talent code:"] = "Вставьте код талантов DragonUI:"
L["Talent import: %s"] = "Импорт талантов: %s"
L["Talent build code (Ctrl+C to copy):"] = "Код сборки талантов (Ctrl+C — копировать):"
L["Build saved: %s"] = "Сборка сохранена: %s"
L["Build saved for %s: %s"] = "Сборка сохранена для класса %s: %s"
L["Build sent (%s). Only DragonUI players will see it."] = "Сборка отправлена (%s). Её увидят только игроки с DragonUI."
L["%s shared a talent build with you:"] = "%s поделился с вами сборкой талантов:"
L["Imported"] = "Импортировано"
L["couldn't read a talent code"] = "не удалось прочитать код талантов"
L["talent data unavailable"] = "данные талантов недоступны"
L["that build doesn't fit your talent trees"] = "эта сборка не подходит к вашим деревьям талантов"
L["Import to My Profiles"] = "Импортировать в мои профили"
L["Save this build to your talent profiles."] = "Сохранить эту сборку в ваших профилях талантов."
