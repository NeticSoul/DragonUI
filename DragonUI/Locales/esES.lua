...
L["World map module disabled: %s replaces the same map frame."] = "Modulo de mapa del mundo desactivado: %s reemplaza el mismo marco de mapa."
L["Cursor"] = "Cursor"
L["Show Zone Levels"] = "Mostrar niveles de zona"
L["Show Map Coordinates"] = "Mostrar coordenadas del mapa"
...
L["Spellbook module disabled: %s replaces the same spellbook frame."] = "Módulo de libro de hechizos desactivado: %s reemplaza la misma ventana del libro de hechizos."
...
L["To Learn"] = "Por aprender"
L["Requires Level"] = "Nivel requerido"
