...
L["None active."] = true
L["New Loadout"] = true
L["Starter Build"] = true
L["Right-click: Rename / Delete"] = true
L["Click: Apply build"] = true
L["Delete loadout '%s'? This cannot be undone."] = true
L["Loadouts"] = true
L["Post Link"] = true
L["Save and apply this shared build:"] = true
L["Talent loadout export (Ctrl+C to copy):"] = true
L["Accept"] = true
L["Selection Settings"] = true
L["Name this imported loadout:"] = true
L["Paste a talent build string (Ctrl+V):"] = true
L["Name this loadout (saves your current spec):"] = true
L["Cannot apply loadout right now."] = true
L["%d points staged on talent group %d. Click \"Apply Changes\" to commit."] = true
L["%d points conflict with this spec (need a respec); %d staged."] = true
L["0 points staged. No unspent points, or this spec is already set."] = true
