...
L["Level Up Enhance"] = "Subida de Nivel"
L["Enhanced level-up notification with animated frame"] = "Notificación de subida de nivel mejorada con marco animado"
...
L["Plays a sound and flashes the screen edges when your HP drops below the threshold."] = "Reproduce un sonido y hace parpadear los bordes de la pantalla cuando tu HP cae por debajo del umbral."

-- Talents
L["Talents"] = "Talentos"
L["Retail-style talent window"] = "Ventana de talentos estilo actual"
L["points available"] = "puntos disponibles"
L["Search talents"] = "Buscar talentos"
L["Rename specialization"] = "Renombrar especialización"
L["Glyph options"] = "Opciones de glifos"
L["Toggle slot name labels and the active-effects list."] = "Alternar las etiquetas de los nombres de los huecos y la lista de efectos activos."
...
L["None active."] = "Ninguno activo."
L["Delete loadout '%s'? This cannot be undone."] = "¿Eliminar la configuración «%s»? Esta acción no se puede deshacer."
L["Rename this specialization (max %d characters):"] = "Renombrar esta especialización (máx. %d caracteres):"
L["Apply Changes"] = "Aplicar cambios"
L["Save Build"] = "Guardar configuración"
L["Undo the last point"] = "Deshacer el último punto"
L["Exit Editor"] = "Salir del editor"
L["Back to your live talents. Saved builds keep every change."] = "Vuelve a tus talentos actuales. Las configuraciones guardadas conservan cada cambio."
L["Talent Builds"] = "Configuraciones de talentos"
L["Design and save builds offline — no points needed."] = "Diseña y guarda configuraciones sin gastar puntos."
L["New build"] = "Nueva configuración"
L["New build from current talents"] = "Nueva configuración a partir de los talentos actuales"
L["Copy code"] = "Copiar código"
L["Post link in chat"] = "Publicar enlace en el chat"
L["Asking %s for the build…"] = "Pidiendo la configuración a %s…"
L["%s didn't answer — they may be offline or not running DragonUI."] = "%s no ha respondido: puede que esté desconectado o que no use DragonUI."
L["Import code…"] = "Importar código…"
L["Load onto character"] = "Cargar en el personaje"
L["Edit"] = "Editar"
L["Rename"] = "Renombrar"
L["Editing: %s"] = "Editando: %s"
L["Level Required: %d"] = "Nivel requerido: %d"
L["(auto)"] = "(auto)"
L["%d / %d points · Level %d"] = "%d / %d puntos · Nivel %d"
L["In this build: rank %d / %d"] = "En esta configuración: rango %d / %d"
L["Not in this build"] = "No está en esta configuración"
L["This build isn't saved — exit and discard it?"] = "Esta configuración no está guardada. ¿Salir y descartarla?"
L["Discard"] = "Descartar"
L["This build conflicts with talents you've already spent.\n\nVisit your class trainer to reset your talents, then load the build again."] = "Esta configuración entra en conflicto con talentos que ya has gastado.\n\nVisita a tu instructor de clase para reiniciar tus talentos y vuelve a cargarla."
L["Character already matches this build."] = "El personaje ya coincide con esta configuración."
L["This build needs %d points; you have %d unspent."] = "Esta configuración necesita %d puntos; tienes %d sin gastar."
L["Build staged — click Apply Changes to learn it."] = "Configuración preparada: pulsa «Aplicar cambios» para aprenderla."
L["Name this build:"] = "Pon un nombre a esta configuración:"
L["Level required for this build (10-%d).\nLeave blank for automatic (grows with the build)."] = "Nivel requerido para esta configuración (10-%d).\nDéjalo vacío para automático (crece con la configuración)."
L["Level clamped to %d (build size / level cap)."] = "Nivel ajustado a %d (tamaño de la configuración / nivel máximo)."
L["Paste a DragonUI talent code:"] = "Pega un código de talentos de DragonUI:"
L["Talent import: %s"] = "Importación de talentos: %s"
L["Talent build code (Ctrl+C to copy):"] = "Código de la configuración de talentos (Ctrl+C para copiar):"
L["Build saved: %s"] = "Configuración guardada: %s"
L["Build saved for %s: %s"] = "Configuración guardada para %s: %s"
L["Build sent (%s). Only DragonUI players will see it."] = "Configuración enviada (%s). Solo la verán los jugadores con DragonUI."
L["%s shared a talent build with you:"] = "%s ha compartido contigo una configuración de talentos:"
L["Imported"] = "Importada"
L["couldn't read a talent code"] = "no se ha podido leer un código de talentos"
L["talent data unavailable"] = "datos de talentos no disponibles"
L["that build doesn't fit your talent trees"] = "esa configuración no encaja con tus árboles de talentos"
L["Import to My Profiles"] = "Importar a mis perfiles"
L["Save this build to your talent profiles."] = "Guarda esta configuración en tus perfiles de talentos."
