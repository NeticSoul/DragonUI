...
L["Rename this specialization (letters only, max %d):"] = "Renombrar esta especialización (solo letras, máx. %d):"
L["Remove this glyph?"] = "¿Eliminar este glifo?"
L["Activate"] = "Activar"
L["ACTIVE EFFECTS"] = "EFECTOS ACTIVOS"
L["MAJOR GLYPHS"] = "GLIFOS MAYORES"
L["MINOR GLYPHS"] = "GLIFOS MENORES"
L["points spent"] = "puntos gastados"
...
L["New Loadout"] = "Nueva configuración de talentos"
L["Starter Build"] = "Configuración inicial"
L["Right-click: Rename / Delete"] = "Clic derecho: Renombrar / Eliminar"
L["Click: Apply build"] = "Clic: Aplicar configuración"
L["Delete loadout '%s'? This cannot be undone."] = "¿Eliminar la configuración «%s»? Esta acción no se puede deshacer."
L["Loadouts"] = "Configuraciones de talentos"
L["Post Link"] = "Enviar enlace"
L["Save and apply this shared build:"] = "Guardar y aplicar esta configuración compartida:"
L["Talent loadout export (Ctrl+C to copy):"] = "Exportación de configuración de talentos (Ctrl+C para copiar):"
L["Accept"] = "Aceptar"
L["Selection Settings"] = "Opciones de selección"
L["Name this imported loadout:"] = "Pon un nombre a esta configuración importada:"
L["Paste a talent build string (Ctrl+V):"] = "Pega un código de talentos (Ctrl+V):"
L["Name this loadout (saves your current spec):"] = "Pon un nombre a esta configuración (guarda tu especialización actual):"
L["Cannot apply loadout right now."] = "No se puede aplicar la configuración ahora."
L["%d points staged on talent group %d. Click \"Apply Changes\" to commit."] = "%d puntos preparados en el grupo de talentos %d. Haz clic en \"Aplicar cambios\" para confirmarlos."
L["%d points conflict with this spec (need a respec); %d staged."] = "%d puntos entran en conflicto con esta especialización (se necesita un re-spec); %d preparados."
L["0 points staged. No unspent points, or this spec is already set."] = "0 puntos preparados. No hay puntos sin gastar, o esta especialización ya está configurada."
