...
L["Pets & Mounts"] = "宠物与坐骑"
L["Dedicated window for your mounts and companion pets, opened from the micro menu"] = "专门的坐骑与宠物窗口，从微菜单打开"
...
L["Summon Random Favorite"] = "随机召唤收藏"
L["Picks a favorite you can actually use here, or any of them if none are favorited."] = "挑选一个在此处真正可用的收藏；若没有收藏则任选其一。"
