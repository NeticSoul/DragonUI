...
L["Rename this specialization (letters only, max %d):"] = "重命名此专精（仅限字母，最多 %d 个）："
L["Remove this glyph?"] = "移除这个雕文？"
L["Activate"] = "激活"
L["ACTIVE EFFECTS"] = "已激活效果"
L["MAJOR GLYPHS"] = "大雕文"
L["MINOR GLYPHS"] = "小雕文"
L["points spent"] = "已用点数"
...
L["Right-click: Rename / Delete"] = "右键：重命名 / 删除"
L["Click: Apply build"] = "单击：应用配置"
L["Delete loadout '%s'? This cannot be undone."] = "删除配置“%s”？此操作无法撤销。"
L["Loadouts"] = "配置"
L["Post Link"] = "发送链接"
L["Save and apply this shared build:"] = "保存并应用此共享配置："
L["Talent loadout export (Ctrl+C to copy):"] = "导出天赋配置（按 Ctrl+C 复制）："
L["Accept"] = "接受"
L["Selection Settings"] = "选择设置"
L["Name this imported loadout:"] = "为导入的配置命名："
L["Paste a talent build string (Ctrl+V):"] = "粘贴天赋构建代码（按 Ctrl+V）："
L["Name this loadout (saves your current spec):"] = "为此配置命名（保存当前专精）："
L["Cannot apply loadout right now."] = "现在无法应用配置。"
L["%d points staged on talent group %d. Click \"Apply Changes\" to commit."] = "%d 点已暂存于天赋组 %d。点击“应用更改”以确认。"
L["%d points conflict with this spec (need a respec); %d staged."] = "%d 点与此专精冲突（需要重置天赋）；%d 点已暂存。"
L["0 points staged. No unspent points, or this spec is already set."] = "0 点已暂存。没有未花费的点数，或此专精已设置完成。"
