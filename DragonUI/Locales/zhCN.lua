...
L["Loot Window"] = "拾取窗口"
L["Retail-style skin for the Blizzard loot window"] = "暴雪拾取窗口的正式服风格皮肤"
L["Bagster"] = "Bagster"
...
L["Retail-style character window with a modern frame, class portrait and stats sidebar"] = "正式服风格的角色窗口，带现代边框、职业头像和属性侧边栏"
L["Character Panel restored. Reload the UI for a fully clean state."] = "角色面板已还原。重载界面可完全恢复干净状态。"
L["Pets & Mounts"] = "宠物与坐骑"
L["The mounts and pets you have collected."] = "你已收集的坐骑与宠物。"
L["Dedicated window for your mounts and pets, opened from the micro menu"] = "专门存放坐骑与宠物的窗口，从微型菜单打开"
L["Pets & Mounts disabled. Reload the UI to remove its micro menu button."] = "已禁用宠物与坐骑。重载界面可移除其微菜单按钮。"
L["Favorite"] = "收藏"
L["Remove Favorite"] = "取消收藏"
L["Favorites"] = "收藏"
L["Keeps this at the front of the list."] = "让它保持在列表最前面。"
L["Summon Random Favorite"] = "随机召唤收藏宠物"
L["Mount Random Favorite"] = "随机骑乘收藏坐骑"
L["Summon Random Favorite Mount"] = "随机召唤收藏坐骑"
L["Summon Random Favorite Pet"] = "随机召唤收藏宠物"
L["Total Mounts"] = "坐骑总数"
L["Total Pets"] = "宠物总数"
L["Hide maxed out"] = "隐藏已满级"
L["All"] = "全部"
L["Hide empty"] = "隐藏为空的"
L["Hide inactive"] = "隐藏不活跃的"
L["Random Mount"] = "随机坐骑"
L["Random Pet"] = "随机宠物"
L["Summons and dismisses a favorite mount that is usable in the current area."] = "召唤或解散一个可在当前区域使用的收藏坐骑。"
L["Summons and dismisses a favorite pet."] = "召唤或解散一个收藏宠物。"
L["If you don't have any favorite mounts, it'll choose from your whole collection."] = "如果没有收藏任何坐骑，将从你的全部收藏中挑选。"
L["If you don't have any favorite pets, it'll choose from your whole collection."] = "如果没有收藏任何宠物，将从你的全部收藏中挑选。"
L["None of your favorites can be used here."] = "你的收藏没有一个能在此使用。"
...
L["Collected"] = "已收集"
L["Not Collected"] = "未收集"
L["Drag to place it on an action bar."] = "拖动即可放到动作条上。"
L["No free macro slot for the random favorite button."] = "没有空余的宏栏位可供随机收藏按钮使用。"
L["Unusable here"] = "此处不可用"
L["Ground"] = "地面"
L["Flying"] = "飞行"
L["Aquatic"] = "水中"
L["Sources"] = "来源"
...
L["In-Game Shop"] = "游戏内商城"
L["Discovery"] = "探索发现"
L["/dragonui collections - Open the Pets & Mounts window"] = "/dragonui collections - 打开宠物与坐骑窗口"
L["Average item level of your equipped gear."] = "已装备物品的平均等级。"
L["Equip"] = "装备"
...
L["Greyscale"] = "灰度"
L["Full colour"] = "全彩"
L["You have not earned any titles yet."] = "你还没有获得任何头衔。"
L["This client can only re-save a set, so the gear you are wearing now replaces its contents."] = "此客户端只能重新保存套装，因此当前穿戴的装备会替换其内容。"
...
L["Open the character panel first: sizes are meaningless while hidden."] = "请先打开角色面板：隐藏时尺寸没有意义。"
L["(paperdoll-only rows below are skipped on this tab)"] = "（下方仅适用于人物模型页的行在此标签被跳过）"
...
L["World"] = "世界"
L["Maximize"] = "最大化"
L["Show Quest Log"] = "显示任务日志"
L["Hide Quest Log"] = "隐藏任务日志"
L["Show Landmarks"] = "显示地标"
L["Show Undiscovered Areas"] = "显示未探索区域"
L["No quests on this map."] = "该地图上没有任务。"
L["Untrack"] = "取消追踪"
L["Abandon"] = "放弃"
L["Share"] = "分享"
...
L["World map module disabled: %s replaces the same map frame."] = "世界地图模块已禁用：%s 替换了同一个地图框架。"
L["Cursor"] = "光标"
...
-- Talents
L["Talents"] = "天赋"
L["Retail-style talent window"] = "现代风格的天赋窗口"
L["points available"] = "可用点数"
L["Search talents"] = "搜索天赋"
L["Rename specialization"] = "重命名专精"
L["Glyph options"] = "雕文选项"
L["Toggle slot name labels and the active-effects list."] = "切换插槽名称标签和已激活效果列表。"
L["Show glyph names"] = "显示雕文名称"
L["Show glyph effects"] = "显示雕文效果"
L["NO ACTIVE EFFECTS"] = "无已激活效果"
L["None active."] = "没有已激活的效果。"
L["Delete loadout '%s'? This cannot be undone."] = "删除配置“%s”？此操作无法撤销。"
L["Rename this specialization (max %d characters):"] = "重命名此专精（最多%d个字符）："
L["Apply Changes"] = "应用更改"
L["Save Build"] = "保存配置"
L["Undo the last point"] = "撤销上一点"
L["Exit Editor"] = "退出编辑器"
L["Back to your live talents. Saved builds keep every change."] = "返回当前天赋。已保存的配置会保留所有更改。"
L["Talent Builds"] = "天赋配置"
L["Design and save builds offline — no points needed."] = "无需天赋点即可设计并保存配置。"
L["New build"] = "新配置"
L["New build from current talents"] = "以当前天赋新建配置"
L["Copy code"] = "复制代码"
L["Post link in chat"] = "在聊天中发布链接"
L["Asking %s for the build…"] = "正在向%s请求配置…"
L["%s didn't answer — they may be offline or not running DragonUI."] = "%s没有回应——可能已离线或未运行DragonUI。"
L["Import code…"] = "导入代码…"
L["Load onto character"] = "加载到角色"
L["Edit"] = "编辑"
L["Rename"] = "重命名"
L["Editing: %s"] = "正在编辑：%s"
L["Level Required: %d"] = "需要等级：%d"
L["(auto)"] = "（自动）"
L["%d / %d points · Level %d"] = "%d / %d 点 · 等级 %d"
L["In this build: rank %d / %d"] = "此配置中：%d / %d"
L["Not in this build"] = "不在此配置中"
L["This build isn't saved — exit and discard it?"] = "此配置尚未保存——退出并放弃吗？"
L["Discard"] = "放弃"
L["This build conflicts with talents you've already spent.\n\nVisit your class trainer to reset your talents, then load the build again."] = "此配置与你已分配的天赋冲突。\n\n请前往职业训练师重置天赋，然后再次加载此配置。"
L["Character already matches this build."] = "角色已与此配置一致。"
L["This build needs %d points; you have %d unspent."] = "此配置需要%d点，你有%d点未分配。"
L["Build staged — click Apply Changes to learn it."] = "配置已预置——点击“应用更改”来学习。"
L["Name this build:"] = "为此配置命名："
L["Level required for this build (10-%d).\nLeave blank for automatic (grows with the build)."] = "此配置需要的等级（10-%d）。\n留空则自动（随配置增长）。"
L["Level clamped to %d (build size / level cap)."] = "等级已调整为%d（配置大小/等级上限）。"
L["Paste a DragonUI talent code:"] = "粘贴DragonUI天赋代码："
L["Talent import: %s"] = "天赋导入：%s"
L["Talent build code (Ctrl+C to copy):"] = "天赋配置代码（Ctrl+C复制）："
L["Build saved: %s"] = "配置已保存：%s"
L["Build saved for %s: %s"] = "已为%s保存配置：%s"
L["Build sent (%s). Only DragonUI players will see it."] = "配置已发送（%s）。只有使用DragonUI的玩家能看到。"
L["%s shared a talent build with you:"] = "%s与你分享了一个天赋配置："
L["Imported"] = "已导入"
L["couldn't read a talent code"] = "无法读取天赋代码"
L["talent data unavailable"] = "天赋数据不可用"
L["that build doesn't fit your talent trees"] = "该配置与你的天赋树不符"
L["Import to My Profiles"] = "导入到我的配置"
L["Save this build to your talent profiles."] = "将此配置保存到你的天赋配置中。"
