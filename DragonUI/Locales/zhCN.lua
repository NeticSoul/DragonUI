...
L["Position editor not available."] = "位置编辑器不可用。"
L["Reset only supports resetting every position at once. Use /dragonui reset."] = "重置只支持一次性重置所有位置。请使用 /dragonui reset。"
L["Minimap Decorations"] = "小地图装饰"
L["Native animated minimap decoration effects for DragonUI."] = "DragonUI 原生的小地图动画装饰效果。"
L["Click to sell all gray (poor) items to vendor."] = "点击将所有灰色（粗糙）物品卖给商人。"
L["A merchant window must be open."] = "必须先打开商人窗口。"
L["Sold %d scrap item(s) for %s."] = "已出售 %d 件垃圾物品，获得 %s。"
L["No scrap items to sell."] = "没有可出售的垃圾物品。"
L["Range Indicator"] = "距离指示器"
L["Color action button icons when target is out of range or ability is unusable."] = "当目标超出距离或技能不可用时为动作条图标着色。"
L["Aura Borders"] = "光环边框"
L["Modern borders on buff and debuff icons."] = "为增益与减益图标使用现代风格边框。"
