...
L["Grays the health bar when a unit is tapped by another player or group. Remembers tap status after you mouse away or change target."] = "當單位被其他玩家或隊伍佔領時，將生命條顯示為灰色。移開滑鼠或切換目標後仍會記住佔領狀態。"
