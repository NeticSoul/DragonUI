...
L["Enable this if you use an external nameplate addon (PlateBuffs, Icicle, ...) that isn't detecting DragonUI's nameplates correctly."] = "如果你使用的外部名牌外掛（如 PlateBuffs、Icicle 等）無法正確識別 DragonUI 的名牌，請啟用此選項。"
