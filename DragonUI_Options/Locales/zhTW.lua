...
L["Show the caster's name (class-colored) on buff and debuff tooltips."] = "在增益/減益提示中顯示施放者的職業色名稱。"
L["Aura Tooltips"] = "光環提示"
L["Show Aura Spell ID"] = "顯示法術 ID"
L["Show the spell ID on buff and debuff tooltips. Requires the Tooltip module."] = "在增益/減益提示中顯示法術 ID。需要啟用滑鼠提示模組。"
...
L["Text Only"] = "僅文字"
L["Gold Icons"] = "金幣圖標"
L["(disabled by Colorblind Mode)"] = "(已被色盲模式停用)"
L["Item Scale"] = "物品縮放"
...
L["Custom Height"] = "自訂高度"
L["Limit the tracker to a fixed height. When off, it stops above the bags. Quests that don't fit are hidden until there is room."] = "將追蹤器限制為固定高度。關閉時，它會停在背包上方。放不下的任務會被隱藏，直到有空間為止。"
L["Maximum height of the quest tracker."] = "任務追蹤器的最大高度。"
...
L["Default Profile"] = "預設配置檔案"
L["New characters will use this profile."] = "新角色將使用此配置檔案。"
L["New characters will get their own profile."] = "新角色將使用各自的配置檔案。"
L["New characters will start on profile: "] = "新角色將使用配置檔案："
L["Copy From"] = "從何處複製"
...
L["Plate Style"] = "名牌樣式"
L["Nameplate Art"] = "名牌美術"
L["Heritage is the DragonUI art. Modern draws the current World of Warcraft nameplate chrome and is still in beta."] = "經典為 DragonUI 美術。現代會繪製目前魔獸世界的名牌邊框，仍處於測試階段。"
L["Modern (Beta)"] = "現代（測試版）"
L["Heritage"] = "經典"
L["Mouseover Highlight"] = "滑鼠懸停高亮"
L["Wash the health bar with a bright overlay while the cursor is over the nameplate."] = "游標位於名牌上時，在生命條上覆蓋一層亮色。"
L["Target Selection Border"] = "目標選取邊框"
L["Draw the white glowing border around the current target's health bar."] = "在目前目標的生命條周圍繪製白色發光邊框。"
L["Dim Non-Target Plates"] = "調暗非目標名牌"
L["Lay the retail dim overlay over every nameplate that is not your target."] = "在所有不是你目標的名牌上覆蓋正式服的暗色遮罩。"
L["Retail Threat Colors"] = "正式服仇恨顏色"
L["Use retail's yellow and orange threat steps instead of the yellow, orange and red set."] = "使用正式服的黃色與橙色仇恨等級，而不是黃、橙、紅三色。"
L["Offset X"] = "X 偏移"
L["Offset Y"] = "Y 偏移"
...
L["Percent"] = "百分比"
L["Value"] = "數值"
L["Value and Percent"] = "數值與百分比"
L["After the name, the name is shortened so the two never overlap. With the name inside the health bar, the text always sits at the bar's right end."] = "放在名稱後面時，名稱會被縮短，兩者永不重疊。名稱在生命條內時，文字一律位於生命條右端。"
L["After the Name"] = "名稱後面"
L["Inside the Bar, Centered"] = "生命條內，置中"
L["Inside the Bar, Right"] = "生命條內，靠右"
L["Inside the Bar, Value Left and Percent Right"] = "生命條內，數值靠左，百分比靠右"
L["Center Name"] = "名稱置中"
L["Center the name in the space the health text leaves free."] = "在生命值文字留下的空間內將名稱置中。"
L["Font size of the name, and of the health text when it follows the name (1-10, default 2)."] = "名稱的字型大小，以及跟在名稱後面的生命值文字的字型大小（1-10，預設 2）。"
L["Inset the name, level, and health text from the left and right edges of the health bar. Does not affect the elite icon."] = "讓名稱、等級與生命值文字和生命條左右邊緣保持距離。不影響精英圖示。"
L["Show"] = "顯示"
L["Always (anyone's)"] = "總是（任何人的）"
L["Follow 'Only My Debuffs'"] = "依照「僅我的減益」"
L["Only Mine"] = "僅我的"
L["Each listed spell can decide whose casts it shows, whatever 'Only My Debuffs' says."] = "清單中的每個法術都能自行決定顯示誰施放的效果，不受「僅我的減益」影響。"
L["Click an entry to select it."] = "點擊項目以選取。"
L["Click to select."] = "點擊以選取。"
L["Remove Spell"] = "移除法術"
L["Select a spell above to choose whose casts it shows."] = "在上方選取一個法術，以決定顯示誰施放的效果。"
L["Name & Health"] = "名稱與生命值"
L["Name"] = "名稱"
L["Level"] = "等級"
L["Name Position"] = "名稱位置"
L["Above the Health Bar"] = "生命條上方"
L["Inside the Health Bar"] = "生命條內"
L["Moves the name up or down while it sits inside the health bar."] = "名稱位於生命條內時，向上或向下移動名稱。"
L["The name is inside the health bar, so the health text sits at the bar's right end, after the name."] = "名稱位於生命條內，因此生命值文字位於生命條右端、名稱之後。"
L["The Modern style draws its own bar background."] = "現代樣式會繪製自己的生命條背景。"
L["Name Text"] = "名稱文字"
L["Color friendly player names by class. Needs Party Class Colors or Friendly Class Colors."] = "依職業為友方玩家名稱著色。需要啟用「隊伍職業顏色」或「友方職業顏色」。"
L["Color enemy player names by class. Needs Enemy Player Class Colors."] = "依職業為敵方玩家名稱著色。需要啟用「敵方玩家職業顏色」。"
...
L["Color the glow and health bar by threat status (orange = tanking, yellow = gaining or losing)."] = "依仇恨狀態為發光和生命條著色（橙色=正在承受，黃色=正在獲得或失去）。"
...
L["Aura Borders"] = "光環邊框"
L["Enable Aura Borders"] = "啟用光環邊框"
L["Show modern borders around buff and debuff icons."] = "在增益與減益圖示周圍顯示現代風格邊框。"
L["Buff Border Color"] = "增益邊框顏色"
L["Reset Debuff Position"] = "重置減益位置"
L["Debuff position reset."] = "已重置減益位置。"
L["Debuffs detached - positioned freely via Editor Mode"] = "減益已分離 - 可透過編輯模式自由擺放"
L["Debuffs attached - follow buff row"] = "減益已附著 - 跟隨增益列"
L["Opacity of tabs, buttons and chat background when not hovered. 0 = hidden, 1 = always visible."] = "未將滑鼠移至其上時，分頁、按鈕與聊天背景的不透明度。0 = 隱藏，1 = 永遠顯示。"
L["Lock Toggle Hotkey"] = "鎖定切換快捷鍵"
L["Choose the modifier + mouse button used to lock or unlock a bag slot while hovering it."] = "選擇用來鎖定或解除鎖定滑鼠所指背包格子的組合鍵與滑鼠按鍵。"
L["Use /sortlock to lock or unlock the currently hovered slot from chat."] = "可在聊天框使用 /sortlock 鎖定或解除鎖定目前滑鼠所指的格子。"
L["Reverse Stack Order"] = "反轉堆疊順序"
L["Stack sorted items from the end of each bag so empty slots stay at the top."] = "從每個背包的末端開始堆放已整理的物品，使空格保留在上方。"
...
L["Alt + Middle Click"] = "Alt + 中鍵點擊"
L["Ctrl + Middle Click"] = "Ctrl + 中鍵點擊"
L["Shift + Middle Click"] = "Shift + 中鍵點擊"

-- Added by DragonUI (missing translations)
L["Extra Bar Scale"] = "額外動作條縮放"
L["Bar"] = "動作條"

-- Added by DragonUI (missing translations)
L["Hide the main bar while in combat."] = "戰鬥中隱藏主動作條。"
L["Fade the quest tracker until you hover over it."] = "在滑鼠移至其上之前淡出任務追蹤器。"
L["Fade the quest tracker until you enter combat."] = "在進入戰鬥之前淡出任務追蹤器。"
L["Hide the quest tracker while in combat."] = "戰鬥中隱藏任務追蹤器。"
L["Fade the XP and Reputation bars until you hover over them."] = "在滑鼠移至其上之前淡出經驗條與聲望條。"
L["Fade the XP and Reputation bars until you enter combat."] = "在進入戰鬥之前淡出經驗條與聲望條。"
L["Hide the XP and Reputation bars while in combat."] = "戰鬥中隱藏經驗條與聲望條。"
L["Fade the player frame until you hover over it."] = "在滑鼠移至其上之前淡出玩家框體。"
L["Fade the player frame until you enter combat."] = "在進入戰鬥之前淡出玩家框體。"
L["Also fades the Target of Target and target cast bar, attached or not."] = "同時淡出目標的目標與目標施法條，無論是否附著。"
L["Fade the target frame group until you hover over it."] = "在滑鼠移至其上之前淡出目標框體群組。"
L["Fade the target frame group until you enter combat."] = "在進入戰鬥之前淡出目標框體群組。"
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "同時淡出專注目標的目標與專注目標施法條，無論是否附著。"
L["Fade the focus frame group until you hover over it."] = "在滑鼠移至其上之前淡出專注目標框體群組。"
L["Fade the focus frame group until you enter combat."] = "在進入戰鬥之前淡出專注目標框體群組。"
L["Fade the pet frame until you hover over it."] = "在滑鼠移至其上之前淡出寵物框體。"
L["Fade the pet frame until you enter combat."] = "在進入戰鬥之前淡出寵物框體。"
L["Fade party frames until you hover over them."] = "在滑鼠移至其上之前淡出隊伍框體。"
L["Fade party frames until you enter combat."] = "在進入戰鬥之前淡出隊伍框體。"
L["Fade boss frames until you hover over them."] = "在滑鼠移至其上之前淡出首領框體。"
L["Fade boss frames until you enter combat."] = "在進入戰鬥之前淡出首領框體。"
L["Boss"] = "首領"
L["Fade the stance bar until you hover over it."] = "在滑鼠移至其上之前淡出姿態條。"
L["Fade the stance bar until you enter combat."] = "在進入戰鬥之前淡出姿態條。"
L["Fade the pet bar until you hover over it."] = "在滑鼠移至其上之前淡出寵物動作條。"
L["Fade the pet bar until you enter combat."] = "在進入戰鬥之前淡出寵物動作條。"
L["Fade the totem bar until you hover over it."] = "在滑鼠移至其上之前淡出圖騰條。"
L["Fade the totem bar until you enter combat."] = "在進入戰鬥之前淡出圖騰條。"
L["Fade the minimap until you hover over it."] = "在滑鼠移至其上之前淡出小地圖。"
L["Fade the minimap until you enter combat."] = "在進入戰鬥之前淡出小地圖。"
L["Experimental:"] = "實驗性："
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "淡出小地圖偶爾會導致追蹤圖示在 /reload 之前停止更新。請自行斟酌使用。"
L["Has no effect while SexyMap controls the minimap (SexyMap or Hybrid mode)."] = "當 SexyMap 控制小地圖時無效（SexyMap 或混合模式）。"
L["Hide in Combat"] = "戰鬥中隱藏"
L["Hide the minimap while in combat."] = "戰鬥中隱藏小地圖。"

-- Added by DragonUI (missing translations)
L["Modern Icon Border Desc"] = "使用 DragonUI 動作條邊框取代傳統圓環來包覆法術圖示。"

-- Added by DragonUI (missing translations)
L["Total icons in the row. Buffs and debuffs share these slots, lowest priority drops first."] = "該列的圖示總數。增益與減益共用這些格位，優先度最低者最先捨棄。"
L["Lets stuns, fears and polymorphs from anyone through the Only My Debuffs filter. Enemy crowd control matters no matter who cast it."] = "即使套用「僅我的減益」篩選，仍顯示任何人施放的暈眩、恐懼與變形。敵方控制效果無論由誰施放都很重要。"
L["Show buffs on enemy plates in the same row as debuffs. They compete for the same slots, ordered by priority."] = "在敵方名條上將增益與減益顯示於同一列。兩者爭奪相同格位，並依優先度排序。"
L["Purgeable shows what you can spellsteal or dispel, plus defensive cooldowns worth waiting out. No list to maintain."] = "「可驅散」會顯示你能偷取或驅散的效果，以及值得等待結束的防禦性冷卻。無需維護清單。"
L["Only My Buffs"] = "僅我的增益"
L["Only show buffs you applied yourself."] = "僅顯示由你自己施加的增益。"
L["Priority"] = "優先度"
L["Sort Order"] = "排序方式"
L["Priority puts your crowd control first, then anyone's crowd control, enemy defensives, your debuffs and the rest. Chronological sorts by time left only."] = "「優先度」會先排你的控制效果，接著是任何人的控制、敵方防禦、你的減益，其餘在後。「依時間」僅依剩餘時間排序。"
L["Scale Icons by Priority"] = "依優先度縮放圖示"
L["Draws higher-priority auras larger. Icons stay bottom-aligned, so the big ones grow upward without shifting the row."] = "將優先度較高的光環畫得更大。圖示維持底部對齊，因此大圖示向上延伸而不會推移整列。"
L["Tints the icon frame by category: crowd control, enemy defensives, purgeable buffs, and dispel type for everything else."] = "依類別為圖示外框上色：控制效果、敵方防禦、可驅散增益，其餘則依驅散類型。"
L["Color by Dispel Type"] = "依驅散類型上色"
L["Show All Debuffs on Allies"] = "顯示友方的所有減益"
L["Decides which icons come first, and which drop off when there is no room. Importance puts crowd control first, then enemy defensives, then your own debuffs."] = "決定哪些圖示排在前面，以及空間不足時捨棄哪些。「重要度」優先控制效果，其次敵方防禦，再來是你自己的減益。"
L["Extra Crowd Control Spells"] = "額外控制法術"
L["Show stuns, fears and polymorphs on allies even when they are not in the list."] = "即使不在清單中，仍顯示友方身上的暈眩、恐懼與變形。"
L["An ally in a raid carries dozens of auras, so nothing is shown unless you ask for it below."] = "團隊中的友方身上有數十個光環，因此除非你於下方指定，否則不顯示任何內容。"
L["Highlighted auras draw larger than the rest. Everything else uses the base icon size."] = "被強調的光環會畫得比其餘更大，其餘則使用基本圖示尺寸。"
L["Same rule as the Blizzard target frame: each debuff takes the colour of its dispel type, and one without a type uses None."] = "與暴雪目標框體相同的規則：每個減益採用其驅散類型的顏色，沒有類型者使用「無」。"
L["Crowd control uses its own colour instead of its dispel type."] = "控制效果使用自己的顏色，而非驅散類型的顏色。"
L["Order: your crowd control, others' crowd control, enemy defensives, your debuffs, purgeable buffs, others' debuffs."] = "順序：你的控制、他人的控制、敵方防禦、你的減益、可驅散增益、他人的減益。"
L["Higher priority draws larger."] = "優先度越高，畫得越大。"
L["Tint the icon frame by category."] = "依類別為圖示外框上色。"
L["Enemy Defensives"] = "敵方防禦"
L["Purgeable"] = "可驅散"
L["Everything else uses its Magic, Curse, Disease or Poison color."] = "其餘皆使用其魔法、詛咒、疾病或中毒的顏色。"
L["Purgeable means Magic or Enrage, plus the defensive list below."] = "「可驅散」指魔法或激怒，再加上下方的防禦清單。"
L["Categories"] = "類別"
L["These lists decide which auras count as defensive or as crowd control, for both sorting and border color."] = "這些清單決定哪些光環算是防禦或控制效果，同時影響排序與邊框顏色。"
L["Extra Crowd Control"] = "額外控制效果"
L["Added on top of the built-in crowd control list."] = "在內建的控制效果清單之上追加。"
L["Only the spells listed below are shown, never anything else."] = "僅顯示下方列出的法術，絕不顯示其他內容。"
L["Show auras on friendly nameplates. Only the spells listed below are ever shown: an ally in a raid carries dozens and any other rule fills the screen."] = "在友方名條上顯示光環。僅會顯示下方列出的法術：團隊中的友方身上有數十個光環，其他任何規則都會塞滿畫面。"
L["Tints plain debuffs by their dispel type (Magic, Curse, Disease, Poison). Crowd control and defensives keep their own color."] = "依驅散類型（魔法、詛咒、疾病、中毒）為一般減益上色。控制效果與防禦效果保留自己的顏色。"
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "利用戰鬥記錄推測你未選取單位的施法。準確度低於上方的目標、專注目標、滑鼠指向與競技場敵人。"
L["Sync From Native Cast Bar"] = "與原生施法條同步"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "在支援的客戶端上，使用遊戲內建的名條施法條以取得更準確的時間。可安全維持啟用。"
L["Native Progress Sync for Off-Target Casts"] = "非目標施法的原生進度同步"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "在可用時，以戰鬥記錄為基礎的非目標施法條會從暴雪原生施法條同步進度。"
L["showVKeyCastbar Mode"] = "showVKeyCastbar 模式"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto：保留客戶端數值。force_on/off：名條模組啟用期間由 DragonUI 設定 showVKeyCastbar。"
L["Auto (Do Not Force)"] = "自動（不強制）"
L["Force On"] = "強制開啟"
L["Force Off"] = "強制關閉"
L["Quest"] = "任務"
L["Quest Icons"] = "任務圖示"
L["Show Quest Icons"] = "顯示任務圖示"
L["Show kill/loot icons over your quest-objective mobs. Without awesome_wotlk, only your target, mouseover and focus show them."] = "在任務目標怪物上方顯示擊殺/拾取圖示。若無 awesome_wotlk，僅有你的目標、滑鼠指向與專注目標會顯示。"
L["Pointer Mode"] = "指標模式"
L["Show a single quest marker on any objective mob instead of separate kill/loot icons."] = "在任何目標怪物上顯示單一任務標記，而非分開的擊殺/拾取圖示。"
L["Kill Icon"] = "擊殺圖示"
L["Choose the icon shown for kill objectives."] = "選擇擊殺目標所顯示的圖示。"
L["Sword"] = "劍"
L["Skull"] = "骷髏"
L["Elite"] = "精英"
L["Elite Kill Icon"] = "精英擊殺圖示"
L["Show a distinct icon on elite and rare kill objectives."] = "為精英與稀有擊殺目標顯示不同的圖示。"
L["Loot Icon"] = "拾取圖示"
L["Choose the icon shown for loot/collect objectives."] = "選擇拾取/收集目標所顯示的圖示。"
L["Bag"] = "背包"
L["Chest"] = "寶箱"
L["Pointer"] = "指標"
L["Pointer Icon"] = "指標圖示"
...
L["Test Preview"] = "測試預覽"
L["Preview Icon"] = "預覽圖示"
L["Force one icon on all enemy nameplates so you can position and size it. Set to Off when done."] = "在所有敵方名條上強制顯示一個圖示，方便你調整位置與大小。完成後請設為關閉。"
...
-- Character Panel, Pets & Mounts and diagnostics
L["Commands: /dragonui, /dui, /pi \226\128\148 /dragonui edit (editor) \226\128\148 /dragonui help"] = "指令：/dragonui、/dui、/pi — /dragonui edit（編輯器）— /dragonui help"
L["Color the class name in the \"Level X Race Class\" line."] = "為\"等級 X 種族 職業\"一行中的職業名著色。"
L["Auto-show bars: Stance (Warriors/Druids/DKs) \226\128\162 Pet (Hunters/Warlocks/DKs) \226\128\162 Vehicle (All classes) \226\128\162 Totem (Shamans)"] = "自動顯示動作條：姿態（戰士/德魯伊/死騎）• 寵物（獵人/術士/死騎）• 載具（所有職業）• 圖騰（薩滿）"
L["Visual enhancements that add Dragonflight-style polish to the UI. These are optional \226\128\148 disable any you don't want."] = "為介面增添 Dragonflight 風格的視覺優化。均為選用 — 不想要的可以關閉。"
L["Detached \226\128\148 positioned freely via Editor Mode"] = "分離 — 在編輯模式中自由擺放"
...
L["Set which stat and which combat panel lead the list:"] = "選擇哪項屬性和哪個戰鬥面板排在清單最前:"
L["Highlight Main Stat"] = "高亮主屬性"
L["The attribute your class is built around."] = "你的職業所依賴的屬性。"
L["Auto (by class)"] = "自動(依職業)"
L["Combat Statistics"] = "戰鬥數據"
L["Which one leads the list: Melee, Ranged, or Spell."] = "哪個排在清單最前:近戰、遠程或法術。"
...
L["Apply the DragonUI reskin to the world map."] = "將 DragonUI 外觀套用至世界地圖。"
L["Show Undiscovered Areas"] = "顯示未探索區域"
L["Draw the map art of areas you have not explored yet, dimmed."] = "以暗色繪製尚未探索區域的地圖圖像。"
L["Show Landmarks"] = "顯示地標"
L["Show Map Coordinates"] = "顯示地圖座標"
L["Show your coordinates and the cursor's in the corner of the map."] = "在地圖角落顯示你的座標和游標座標。"
L["Show Zone Levels"] = "顯示區域等級"
L["Show the recommended level range next to zone names and instance pins."] = "在區域名稱和地城標記旁顯示建議等級範圍。"
L["Fade Map While Moving"] = "移動時淡化地圖"
L["Dim the map while you move, unless the cursor is over it."] = "移動時淡化地圖，除非游標停留在地圖上。"
L["Moving Map Alpha"] = "移動時透明度"
L["How visible the map stays while you move."] = "移動時地圖保持的可見度。"
L["Show towns, flight points and other landmark pins on the map."] = "在地圖上顯示城鎮、飛行點與其他地標。"
L["Show Dungeon Entrances"] = "顯示地城入口"
L["Show dungeon and raid entrance pins on zone maps."] = "在區域地圖上顯示地城與團隊副本入口。"
...
L["Plays a sound and flashes the screen edges when your HP drops below the configured threshold."] = "當你的HP低於設定的臨界值時，發出聲音並閃爍屏幕邊緣。"
L["Enable Low HP Alert"] = "啟用低HP警報"
L["Warning Sound (every 3 sec)"] = "警告聲音（每3秒）"
L["Plays a warning sound every 3 seconds while HP is below threshold."] = "當HP低於臨界值時，每3秒播放一次警告聲音。"
L["Screen Edge Flash"] = "屏幕邊緣閃爍"
L["Flashes red at the edges of the screen while HP is below threshold."] = "當HP低於臨界值時，屏幕邊緣閃爍紅色。"
L["Flash Color"] = "閃爍顏色"
L["Use Class Color"] = "使用職業顏色"
L["Use your class color (e.g. orange for Druid, yellow for Rogue) instead of the custom color."] = "使用你的職業顏色（例如：德魯伊為橙色，盜賊為黃色）代替自定義顏色。"
L["Flash Opacity"] = "閃爍透明度"
L["Maximum opacity of the flash effect."] = "閃爍效果的最大透明度。"
L["Flash Extent"] = "閃爍範圍"
L["How far the flash extends from the screen edges toward the center, in pixels."] = "閃爍從屏幕邊緣向中心延伸的距離，以像素為單位。"
L["HP Warning Threshold"] = "HP警告臨界值"
