...
L["Player Aura Spacing"] = "Spieler-Aura-Abstand"
...
L["Grays the health bar when a unit is tapped by another player or group. Remembers tap status after you mouse away or change target."] = "Färbt den Lebensbalken grau, wenn eine Einheit von einem anderen Spieler oder einer anderen Gruppe getappt ist. Merkt sich den Tap-Status, nachdem der Mauszeiger weggezogen oder das Ziel gewechselt wurde."
