...
L["Enable this if you use an external nameplate addon (PlateBuffs, Icicle, ...) that isn't detecting DragonUI's nameplates correctly."] = "Aktiviere dies, wenn du ein externes Namensplaketten-Addon (PlateBuffs, Icicle, ...) verwendest, das DragonUIs Namensplaketten nicht korrekt erkennt."
