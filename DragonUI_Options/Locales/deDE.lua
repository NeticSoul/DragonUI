...
L["Show the caster's name (class-colored) on buff and debuff tooltips."] = "Zeigt den klassengefärbten Namen des Wirkenden in Buff-/Debuff-Tooltips."
L["Aura Tooltips"] = "Aura-Tooltips"
L["Show Aura Spell ID"] = "Zauber-ID der Aura anzeigen"
L["Show the spell ID on buff and debuff tooltips. Requires the Tooltip module."] = "Zeigt die Zauber-ID in Buff-/Debuff-Tooltips. Erfordert das Tooltip-Modul."

-- Chat Mods
L["Enable Chat Mods"] = "Chat-Mods aktivieren"
L["Enables or disables Chat Mods."] = "Aktiviert oder deaktiviert Chat-Mods."
L["Show Link Tooltips on Hover"] = "Link-Tooltips beim Darüberfahren anzeigen"
L["Show tooltips for supported chat links without holding Alt."] = "Tooltips für unterstützte Chat-Links anzeigen, ohne Alt gedrückt zu halten."
...
L["New characters will use this profile."] = "Neue Charaktere verwenden dieses Profil."
L["New characters will get their own profile."] = "Neue Charaktere erhalten ein eigenes Profil."
L["New characters will start on profile: "] = "Neue Charaktere starten mit Profil: "
...
L["Plate Style"] = "Plakettenstil"
L["Nameplate Art"] = "Plakettengrafik"
L["Heritage is the DragonUI art. Modern draws the current World of Warcraft nameplate chrome and is still in beta."] = "Klassisch ist die DragonUI-Grafik. Modern zeichnet den aktuellen Namensplaketten-Rahmen von World of Warcraft und ist noch in der Beta."
L["Modern (Beta)"] = "Modern (Beta)"
L["Heritage"] = "Klassisch"
L["Mouseover Highlight"] = "Mouseover-Hervorhebung"
L["Wash the health bar with a bright overlay while the cursor is over the nameplate."] = "Überzieht den Gesundheitsbalken mit einer hellen Ebene, solange der Mauszeiger über der Namensplakette ist."
L["Target Selection Border"] = "Zielauswahlrahmen"
L["Draw the white glowing border around the current target's health bar."] = "Zeichnet den weiß leuchtenden Rahmen um den Gesundheitsbalken des aktuellen Ziels."
L["Dim Non-Target Plates"] = "Nicht-Ziel-Plaketten abdunkeln"
L["Lay the retail dim overlay over every nameplate that is not your target."] = "Legt die Retail-Abdunklung über jede Namensplakette, die nicht dein Ziel ist."
L["Retail Threat Colors"] = "Retail-Bedrohungsfarben"
L["Use retail's yellow and orange threat steps instead of the yellow, orange and red set."] = "Verwendet die gelben und orangen Bedrohungsstufen von Retail statt Gelb, Orange und Rot."
...
L["Percent"] = "Prozent"
L["Value"] = "Wert"
L["Value and Percent"] = "Wert und Prozent"
L["After the name, the name is shortened so the two never overlap. With the name inside the health bar, the text always sits at the bar's right end."] = "Nach dem Namen wird der Name gekürzt, damit sich beide nie überlappen. Steht der Name im Gesundheitsbalken, sitzt der Text immer am rechten Ende des Balkens."
L["After the Name"] = "Nach dem Namen"
L["Inside the Bar, Centered"] = "Im Balken, zentriert"
L["Inside the Bar, Right"] = "Im Balken, rechts"
L["Inside the Bar, Value Left and Percent Right"] = "Im Balken, Wert links und Prozent rechts"
L["Center Name"] = "Name zentrieren"
L["Center the name in the space the health text leaves free."] = "Zentriert den Namen in dem Platz, den der Gesundheitstext frei lässt."
L["Font size of the name, and of the health text when it follows the name (1-10, default 2)."] = "Schriftgröße des Namens und des Gesundheitstexts, wenn er dem Namen folgt (1-10, Standard 2)."
L["Inset the name, level, and health text from the left and right edges of the health bar. Does not affect the elite icon."] = "Rückt Name, Level und Gesundheitstext vom linken und rechten Rand des Gesundheitsbalkens ein. Betrifft nicht das Elite-Symbol."
L["Show"] = "Anzeigen"
L["Always (anyone's)"] = "Immer (von jedem)"
L["Follow 'Only My Debuffs'"] = "Wie „Nur meine Debuffs“"
L["Only Mine"] = "Nur meine"
L["Each listed spell can decide whose casts it shows, whatever 'Only My Debuffs' says."] = "Jeder gelistete Zauber legt selbst fest, wessen Anwendungen er zeigt, egal was „Nur meine Debuffs“ sagt."
L["Click an entry to select it."] = "Klicke einen Eintrag, um ihn auszuwählen."
L["Click to select."] = "Klicken zum Auswählen."
L["Remove Spell"] = "Zauber entfernen"
L["Select a spell above to choose whose casts it shows."] = "Wähle oben einen Zauber, um festzulegen, wessen Anwendungen er zeigt."
L["Name & Health"] = "Name & Gesundheit"
L["Name"] = "Name"
L["Level"] = "Level"
L["Name Position"] = "Namensposition"
L["Above the Health Bar"] = "Über dem Gesundheitsbalken"
L["Inside the Health Bar"] = "Im Gesundheitsbalken"
L["Moves the name up or down while it sits inside the health bar."] = "Verschiebt den Namen nach oben oder unten, solange er im Gesundheitsbalken steht."
L["The name is inside the health bar, so the health text sits at the bar's right end, after the name."] = "Der Name steht im Gesundheitsbalken, daher sitzt der Gesundheitstext am rechten Ende des Balkens, nach dem Namen."
L["The Modern style draws its own bar background."] = "Der Stil Modern zeichnet seinen eigenen Balkenhintergrund."
L["Name Text"] = "Namenstext"
L["Color friendly player names by class. Needs Party Class Colors or Friendly Class Colors."] = "Färbt die Namen freundlicher Spieler nach Klasse. Benötigt „Klassenfarben in der Gruppe“ oder „Klassenfarben für alle Freunde“."
L["Color enemy player names by class. Needs Enemy Player Class Colors."] = "Färbt die Namen feindlicher Spieler nach Klasse. Benötigt „Klassenfarben feindlicher Spieler“."
...
L["Color the glow and health bar by threat status (orange = tanking, yellow = gaining or losing)."] = "Färbt Leuchteffekt und Lebensbalken nach Bedrohungsstatus (Orange = tankt, Gelb = gewinnt oder verliert Bedrohung)."
...
L["Enable Aura Borders"] = "Aurenränder aktivieren"
L["Show modern borders around buff and debuff icons."] = "Zeigt moderne Ränder um Stärkungs- und Schwächungssymbole."
L["Buff Border Color"] = "Randfarbe für Stärkungszauber"
L["Reset Debuff Position"] = "Position der Schwächungszauber zurücksetzen"
L["Debuff position reset."] = "Position der Schwächungszauber zurückgesetzt."
L["Debuffs detached - positioned freely via Editor Mode"] = "Schwächungszauber losgelöst — frei platzierbar über den Editormodus"
L["Debuffs attached - follow buff row"] = "Schwächungszauber angeheftet — folgen der Stärkungszauberreihe"
L["Opacity of tabs, buttons and chat background when not hovered. 0 = hidden, 1 = always visible."] = "Deckkraft von Reitern, Schaltflächen und Chathintergrund, solange die Maus nicht darüber liegt. 0 = ausgeblendet, 1 = immer sichtbar."
L["Lock Toggle Hotkey"] = "Tastenkürzel zum Sperren"
L["Choose the modifier + mouse button used to lock or unlock a bag slot while hovering it."] = "Wähle Zusatztaste + Maustaste, um einen Taschenplatz unter dem Mauszeiger zu sperren oder freizugeben."
L["Use /sortlock to lock or unlock the currently hovered slot from chat."] = "Mit /sortlock kannst du den Platz unter dem Mauszeiger auch per Chat sperren oder freigeben."
L["Reverse Stack Order"] = "Stapelreihenfolge umkehren"
L["Stack sorted items from the end of each bag so empty slots stay at the top."] = "Sortierte Gegenstände vom Ende jeder Tasche stapeln, damit freie Plätze oben bleiben."
...
L["Usable"] = "Verwendbar"
L["Extra Bar Scale"] = "Skalierung der Extraleiste"
L["Bar"] = "Leiste"
L["Hide the main bar while in combat."] = "Blendet die Hauptleiste im Kampf aus."
L["Fade the quest tracker until you hover over it."] = "Blendet den Questverfolger aus, bis die Maus darüber liegt."
L["Fade the quest tracker until you enter combat."] = "Blendet den Questverfolger aus, bis du in den Kampf gehst."
L["Hide the quest tracker while in combat."] = "Blendet den Questverfolger im Kampf aus."
L["Fade the XP and Reputation bars until you hover over them."] = "Blendet Erfahrungs- und Rufleiste aus, bis die Maus darüber liegt."
L["Fade the XP and Reputation bars until you enter combat."] = "Blendet Erfahrungs- und Rufleiste aus, bis du in den Kampf gehst."
L["Hide the XP and Reputation bars while in combat."] = "Blendet Erfahrungs- und Rufleiste im Kampf aus."
L["Fade the player frame until you hover over it."] = "Blendet das Spielerfenster aus, bis die Maus darüber liegt."
L["Fade the player frame until you enter combat."] = "Blendet das Spielerfenster aus, bis du in den Kampf gehst."
L["Also fades the Target of Target and target cast bar, attached or not."] = "Blendet auch das Ziel des Ziels und die Zauberleiste des Ziels aus, ob angeheftet oder nicht."
L["Fade the target frame group until you hover over it."] = "Blendet die Zielfenstergruppe aus, bis die Maus darüber liegt."
L["Fade the target frame group until you enter combat."] = "Blendet die Zielfenstergruppe aus, bis du in den Kampf gehst."
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "Blendet auch das Ziel des Fokus und die Zauberleiste des Fokus aus, ob angeheftet oder nicht."
L["Fade the focus frame group until you hover over it."] = "Blendet die Fokusfenstergruppe aus, bis die Maus darüber liegt."
L["Fade the focus frame group until you enter combat."] = "Blendet die Fokusfenstergruppe aus, bis du in den Kampf gehst."
L["Fade the pet frame until you hover over it."] = "Blendet das Begleiterfenster aus, bis die Maus darüber liegt."
L["Fade the pet frame until you enter combat."] = "Blendet das Begleiterfenster aus, bis du in den Kampf gehst."
L["Fade party frames until you hover over them."] = "Blendet die Gruppenfenster aus, bis die Maus darüber liegt."
L["Fade party frames until you enter combat."] = "Blendet die Gruppenfenster aus, bis du in den Kampf gehst."
L["Fade boss frames until you hover over them."] = "Blendet die Bossfenster aus, bis die Maus darüber liegt."
L["Fade boss frames until you enter combat."] = "Blendet die Bossfenster aus, bis du in den Kampf gehst."
L["Fade the stance bar until you hover over it."] = "Blendet die Haltungsleiste aus, bis die Maus darüber liegt."
L["Fade the stance bar until you enter combat."] = "Blendet die Haltungsleiste aus, bis du in den Kampf gehst."
L["Fade the pet bar until you hover over it."] = "Blendet die Begleiterleiste aus, bis die Maus darüber liegt."
L["Fade the pet bar until you enter combat."] = "Blendet die Begleiterleiste aus, bis du in den Kampf gehst."
L["Fade the totem bar until you hover over it."] = "Blendet die Totemleiste aus, bis die Maus darüber liegt."
L["Fade the totem bar until you enter combat."] = "Blendet die Totemleiste aus, bis du in den Kampf gehst."
L["Fade the minimap until you hover over it."] = "Blendet die Minikarte aus, bis die Maus darüber liegt."
L["Fade the minimap until you enter combat."] = "Blendet die Minikarte aus, bis du in den Kampf gehst."
L["Experimental:"] = "Experimentell:"
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "Das Ausblenden der Minikarte kann gelegentlich dazu führen, dass Verfolgungssymbole bis zu einem /reload nicht mehr aktualisiert werden. Verwendung auf eigene Gefahr."
L["Has no effect while SexyMap controls the minimap (SexyMap or Hybrid mode)."] = "Ohne Wirkung, solange SexyMap die Minikarte steuert (Modus SexyMap oder Hybrid)."
L["Hide in Combat"] = "Im Kampf ausblenden"
L["Hide the minimap while in combat."] = "Blendet die Minikarte im Kampf aus."
L["Modern Icon Border Desc"] = "Rahmt das Zaubersymbol mit dem DragonUI-Aktionsleistenrand statt mit dem klassischen Ring ein."
L["Total icons in the row. Buffs and debuffs share these slots, lowest priority drops first."] = "Gesamtzahl der Symbole in der Reihe. Stärkungs- und Schwächungszauber teilen sich diese Plätze; die niedrigste Priorität fällt zuerst weg."
L["Lets stuns, fears and polymorphs from anyone through the Only My Debuffs filter. Enemy crowd control matters no matter who cast it."] = "Lässt Betäubungen, Furcht und Verwandlungen von jedem durch den Filter „Nur meine Schwächungszauber“. Kontrolleffekte zählen, egal wer sie gewirkt hat."
L["Show buffs on enemy plates in the same row as debuffs. They compete for the same slots, ordered by priority."] = "Zeigt Stärkungszauber auf Gegnerplaketten in derselben Reihe wie Schwächungszauber. Sie konkurrieren um dieselben Plätze, sortiert nach Priorität."
L["Purgeable shows what you can spellsteal or dispel, plus defensive cooldowns worth waiting out. No list to maintain."] = "„Entfernbar“ zeigt, was du stehlen oder bannen kannst, plus defensive Abklingzeiten, die sich aussitzen lassen. Keine Liste nötig."
L["Only My Buffs"] = "Nur meine Stärkungszauber"
L["Only show buffs you applied yourself."] = "Zeigt nur Stärkungszauber, die du selbst gewirkt hast."
L["Priority"] = "Priorität"
L["Sort Order"] = "Sortierreihenfolge"
L["Priority puts your crowd control first, then anyone's crowd control, enemy defensives, your debuffs and the rest. Chronological sorts by time left only."] = "„Priorität“ stellt deine Kontrolleffekte voran, dann die aller anderen, gegnerische Verteidigungszauber, deine Schwächungszauber und den Rest. „Chronologisch“ sortiert nur nach Restdauer."
L["Scale Icons by Priority"] = "Symbolgröße nach Priorität"
L["Draws higher-priority auras larger. Icons stay bottom-aligned, so the big ones grow upward without shifting the row."] = "Zeichnet Auren mit höherer Priorität größer. Die Symbole bleiben unten ausgerichtet, sodass die großen nach oben wachsen, ohne die Reihe zu verschieben."
L["Tints the icon frame by category: crowd control, enemy defensives, purgeable buffs, and dispel type for everything else."] = "Färbt den Symbolrahmen nach Kategorie: Kontrolleffekte, gegnerische Verteidigungszauber, entfernbare Stärkungszauber und für alles Übrige die Bannart."
L["Color by Dispel Type"] = "Nach Bannart einfärben"
L["Show All Debuffs on Allies"] = "Alle Schwächungszauber bei Verbündeten anzeigen"
L["Decides which icons come first, and which drop off when there is no room. Importance puts crowd control first, then enemy defensives, then your own debuffs."] = "Legt fest, welche Symbole zuerst kommen und welche bei Platzmangel wegfallen. „Wichtigkeit“ stellt Kontrolleffekte voran, dann gegnerische Verteidigungszauber, dann deine eigenen Schwächungszauber."
L["Extra Crowd Control Spells"] = "Zusätzliche Kontrollzauber"
L["Show stuns, fears and polymorphs on allies even when they are not in the list."] = "Zeigt Betäubungen, Furcht und Verwandlungen bei Verbündeten auch dann, wenn sie nicht in der Liste stehen."
L["An ally in a raid carries dozens of auras, so nothing is shown unless you ask for it below."] = "Ein Verbündeter im Schlachtzug trägt Dutzende Auren, daher wird nichts angezeigt, solange du es unten nicht anforderst."
L["Highlighted auras draw larger than the rest. Everything else uses the base icon size."] = "Hervorgehobene Auren werden größer gezeichnet als der Rest. Alles Übrige verwendet die Basisgröße."
L["Same rule as the Blizzard target frame: each debuff takes the colour of its dispel type, and one without a type uses None."] = "Dieselbe Regel wie beim Blizzard-Zielfenster: Jeder Schwächungszauber erhält die Farbe seiner Bannart, einer ohne Art verwendet „Keine“."
L["Crowd control uses its own colour instead of its dispel type."] = "Kontrolleffekte verwenden ihre eigene Farbe statt ihrer Bannart."
L["Order: your crowd control, others' crowd control, enemy defensives, your debuffs, purgeable buffs, others' debuffs."] = "Reihenfolge: deine Kontrolleffekte, fremde Kontrolleffekte, gegnerische Verteidigungszauber, deine Schwächungszauber, entfernbare Stärkungszauber, fremde Schwächungszauber."
L["Higher priority draws larger."] = "Höhere Priorität wird größer gezeichnet."
L["Tint the icon frame by category."] = "Färbt den Symbolrahmen nach Kategorie ein."
L["Enemy Defensives"] = "Gegnerische Verteidigungszauber"
L["Purgeable"] = "Entfernbar"
L["Everything else uses its Magic, Curse, Disease or Poison color."] = "Alles Übrige verwendet seine Farbe für Magie, Fluch, Krankheit oder Gift."
L["Purgeable means Magic or Enrage, plus the defensive list below."] = "„Entfernbar“ bedeutet Magie oder Wutanfall, zuzüglich der Verteidigungsliste unten."
L["Categories"] = "Kategorien"
L["These lists decide which auras count as defensive or as crowd control, for both sorting and border color."] = "Diese Listen bestimmen, welche Auren als Verteidigung oder als Kontrolleffekt gelten — sowohl für die Sortierung als auch für die Randfarbe."
L["Extra Crowd Control"] = "Zusätzliche Kontrolleffekte"
L["Added on top of the built-in crowd control list."] = "Wird zur eingebauten Liste der Kontrolleffekte hinzugefügt."
L["Only the spells listed below are shown, never anything else."] = "Es werden ausschließlich die unten aufgeführten Zauber angezeigt, sonst nichts."
L["Show auras on friendly nameplates. Only the spells listed below are ever shown: an ally in a raid carries dozens and any other rule fills the screen."] = "Zeigt Auren auf freundlichen Namensplaketten. Es werden ausschließlich die unten aufgeführten Zauber angezeigt: Ein Verbündeter im Schlachtzug trägt Dutzende, und jede andere Regel füllt den Bildschirm."
L["Tints plain debuffs by their dispel type (Magic, Curse, Disease, Poison). Crowd control and defensives keep their own color."] = "Färbt einfache Schwächungszauber nach ihrer Bannart (Magie, Fluch, Krankheit, Gift). Kontrolleffekte und Verteidigungszauber behalten ihre eigene Farbe."
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "Nutzt das Kampfprotokoll, um Zauber von Einheiten zu erraten, die du nicht anvisierst. Weniger genau als Ziel, Fokus, Mauszeiger und Arenagegner oben."
L["Sync From Native Cast Bar"] = "Mit nativer Zauberleiste abgleichen"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "Nutzt auf unterstützten Clients die spieleigene Zauberleiste der Namensplaketten für genaueres Timing. Kann bedenkenlos aktiviert bleiben."
L["Native Progress Sync for Off-Target Casts"] = "Native Fortschrittssynchronisierung für Zauber außerhalb des Ziels"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "Wenn verfügbar, gleichen Zauberleisten außerhalb des Ziels ihren Fortschritt mit Blizzards nativer Zauberleiste ab."
L["showVKeyCastbar Mode"] = "Modus für showVKeyCastbar"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto: Clientwert beibehalten. force_on/off: DragonUI setzt showVKeyCastbar, solange das Namensplaketten-Modul aktiv ist."
L["Auto (Do Not Force)"] = "Automatisch (nicht erzwingen)"
L["Force On"] = "Erzwungen an"
L["Force Off"] = "Erzwungen aus"
L["Quest Icons"] = "Questsymbole"
L["Show Quest Icons"] = "Questsymbole anzeigen"
L["Show kill/loot icons over your quest-objective mobs. Without awesome_wotlk, only your target, mouseover and focus show them."] = "Zeigt Tötungs-/Beutesymbole über Kreaturen deiner Questziele. Ohne awesome_wotlk erscheinen sie nur bei Ziel, Mauszeiger und Fokus."
L["Pointer Mode"] = "Zeigermodus"
L["Show a single quest marker on any objective mob instead of separate kill/loot icons."] = "Zeigt eine einzelne Questmarkierung auf jeder Zielkreatur statt getrennter Tötungs-/Beutesymbole."
L["Kill Icon"] = "Tötungssymbol"
L["Choose the icon shown for kill objectives."] = "Wähle das Symbol für Tötungsziele."
L["Sword"] = "Schwert"
L["Skull"] = "Totenschädel"
L["Elite Kill Icon"] = "Elite-Tötungssymbol"
L["Show a distinct icon on elite and rare kill objectives."] = "Zeigt ein eigenes Symbol bei Tötungszielen der Stufen Elite und Selten."
L["Loot Icon"] = "Beutesymbol"
L["Choose the icon shown for loot/collect objectives."] = "Wähle das Symbol für Beute- und Sammelziele."
L["Bag"] = "Tasche"
L["Chest"] = "Truhe"
L["Pointer"] = "Zeiger"
L["Pointer Icon"] = "Zeigersymbol"
L["Off"] = "Aus"
L["Size"] = "Größe"
L["Icon"] = "Symbol"
L["Test Preview"] = "Testvorschau"
...
L["Set which stat and which combat panel lead the list:"] = "Legt fest, welcher Wert und welches Kampf-Panel die Liste anführen:"
L["Highlight Main Stat"] = "Hauptwert hervorheben"
L["The attribute your class is built around."] = "Der Wert, auf dem deine Klasse aufbaut."
L["Auto (by class)"] = "Automatisch (nach Klasse)"
L["Combat Statistics"] = "Kampfstatistiken"
L["Which one leads the list: Melee, Ranged, or Spell."] = "Welches Panel die Liste anführt: Nahkampf, Fernkampf oder Zauber."
...
L["Show your coordinates and the cursor's in the corner of the map."] = "Zeigt deine Koordinaten und die des Cursors in der Ecke der Karte."
L["Show Zone Levels"] = "Gebietsstufen anzeigen"
L["Show the recommended level range next to zone names and instance pins."] = "Zeigt den empfohlenen Stufenbereich neben Gebietsnamen und Instanzmarkierungen."
L["Fade Map While Moving"] = "Karte beim Bewegen abblenden"
L["Dim the map while you move, unless the cursor is over it."] = "Blendet die Karte ab, während du dich bewegst, außer der Cursor liegt darauf."
L["Moving Map Alpha"] = "Transparenz beim Bewegen"
L["How visible the map stays while you move."] = "Wie sichtbar die Karte bleibt, während du dich bewegst."
