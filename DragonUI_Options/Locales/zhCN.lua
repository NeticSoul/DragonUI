...
L["Grays the health bar when a unit is tapped by another player or group. Remembers tap status after you mouse away or change target."] = "当单位被其他玩家或队伍占领时，将生命条显示为灰色。移开鼠标或切换目标后仍会记住占领状态。"
