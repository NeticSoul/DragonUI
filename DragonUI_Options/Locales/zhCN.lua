...
L["Enable this if you use an external nameplate addon (PlateBuffs, Icicle, ...) that isn't detecting DragonUI's nameplates correctly."] = "如果你使用的外部姓名板插件（如 PlateBuffs、Icicle 等）无法正确识别 DragonUI 的姓名板，请启用此选项。"
