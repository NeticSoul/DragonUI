...
L["Show Link Tooltips on Hover"] = "悬停时显示链接提示"
L["Show tooltips for supported chat links without holding Alt."] = "无需按住 Alt 键即可显示支持的聊天链接提示。"
...
L["New characters will use this profile."] = "新角色将使用此配置文件。"
L["New characters will get their own profile."] = "新角色将使用各自的配置文件。"
L["New characters will start on profile: "] = "新角色将使用配置文件："
L["Copy From"] = "从何处复制"
...
L["Plate Style"] = "姓名板样式"
L["Nameplate Art"] = "姓名板美术"
L["Heritage is the DragonUI art. Modern draws the current World of Warcraft nameplate chrome and is still in beta."] = "经典为 DragonUI 美术。现代绘制当前魔兽世界的姓名板边框，仍处于测试阶段。"
L["Modern (Beta)"] = "现代（测试版）"
L["Heritage"] = "经典"
L["Mouseover Highlight"] = "鼠标悬停高亮"
L["Wash the health bar with a bright overlay while the cursor is over the nameplate."] = "光标位于姓名板上时，在生命条上覆盖一层亮色。"
L["Target Selection Border"] = "目标选择边框"
L["Draw the white glowing border around the current target's health bar."] = "在当前目标的生命条周围绘制白色发光边框。"
L["Dim Non-Target Plates"] = "调暗非目标姓名板"
L["Lay the retail dim overlay over every nameplate that is not your target."] = "在所有非当前目标的姓名板上覆盖正式服的暗色遮罩。"
L["Retail Threat Colors"] = "正式服仇恨颜色"
L["Use retail's yellow and orange threat steps instead of the yellow, orange and red set."] = "使用正式服的黄色和橙色仇恨等级，而不是黄、橙、红三色。"
L["Offset X"] = "X 偏移"
L["Offset Y"] = "Y 偏移"
...
L["Display"] = "显示"
L["Health Text"] = "生命值文字"
L["What the health text shows. With both, the value comes first."] = "生命值文字显示的内容。两者都显示时，数值在前。"
L["Percent"] = "百分比"
L["Value"] = "数值"
L["Value and Percent"] = "数值和百分比"
L["After the name, the name is shortened so the two never overlap. With the name inside the health bar, the text always sits at the bar's right end."] = "放在名称后面时，名称会被缩短，两者永不重叠。名称在生命条内时，文字始终位于生命条右端。"
L["After the Name"] = "名称后面"
L["Inside the Bar, Centered"] = "生命条内，居中"
L["Inside the Bar, Right"] = "生命条内，靠右"
L["Inside the Bar, Value Left and Percent Right"] = "生命条内，数值靠左，百分比靠右"
L["Center Name"] = "名称居中"
L["Center the name in the space the health text leaves free."] = "在生命值文字留出的空间内居中显示名称。"
L["Font size of the name, and of the health text when it follows the name (1-10, default 2)."] = "名称的字体大小，以及跟在名称后面的生命值文字的字体大小（1-10，默认 2）。"
L["Inset the name, level, and health text from the left and right edges of the health bar. Does not affect the elite icon."] = "让名称、等级和生命值文字与生命条左右边缘保持距离。不影响精英图标。"
L["Show"] = "显示"
L["Always (anyone's)"] = "总是（任何人的）"
L["Follow 'Only My Debuffs'"] = "遵循“仅我的减益”"
L["Only Mine"] = "仅我的"
L["Each listed spell can decide whose casts it shows, whatever 'Only My Debuffs' says."] = "列表中的每个法术都可以自行决定显示谁施放的效果，不受“仅我的减益”影响。"
L["Click an entry to select it."] = "点击条目以选中。"
L["Click to select."] = "点击以选中。"
L["Remove Spell"] = "移除法术"
L["Select a spell above to choose whose casts it shows."] = "在上方选择一个法术，以决定显示谁施放的效果。"
L["Name & Health"] = "名称与生命值"
L["Name"] = "名称"
L["Level"] = "等级"
L["Name Position"] = "名称位置"
L["Above the Health Bar"] = "生命条上方"
L["Inside the Health Bar"] = "生命条内"
L["Moves the name up or down while it sits inside the health bar."] = "名称位于生命条内时，向上或向下移动名称。"
L["The name is inside the health bar, so the health text sits at the bar's right end, after the name."] = "名称位于生命条内，因此生命值文字位于生命条右端、名称之后。"
L["The Modern style draws its own bar background."] = "现代样式会绘制自己的生命条背景。"
L["Name Text"] = "名称文字"
L["Color friendly player names by class. Needs Party Class Colors or Friendly Class Colors."] = "按职业为友方玩家名称着色。需要启用“队伍职业颜色”或“友方职业颜色”。"
L["Color enemy player names by class. Needs Enemy Player Class Colors."] = "按职业为敌方玩家名称着色。需要启用“敌方玩家职业颜色”。"
L["Font size of the health text inside the bar (1-10). After the name, or in the Modern style, it matches the name."] = "生命条内生命值文字的字体大小（1-10）。在名称后面或使用现代样式时，与名称一致。"
L["Text Outline"] = "文字描边"
L["Black outline on the name and health text."] = "为名称和生命值文字添加黑色描边。"
...
-- 拾取窗口
L["Loot Window"] = "拾取窗口"
L["Configure the DragonUI loot window."] = "配置 DragonUI 拾取窗口。"
L["Enable Loot Window"] = "启用拾取窗口"
L["Apply the DragonUI skin to the Blizzard loot window."] = "将 DragonUI 皮肤应用到暴雪拾取窗口。"
L["Open at Cursor"] = "在鼠标位置打开"
L["Open the loot window at the cursor instead of its saved position."] = "在鼠标位置而非保存的位置打开拾取窗口。"
L["Disable Open at Cursor, then drag the loot window to save its position."] = "关闭在鼠标位置打开，然后拖动拾取窗口以保存其位置。"
L["Animate Loot Reflow"] = "播放拾取重排动画"
L["Smoothly close gaps and resize the loot window after collecting items."] = "拾取物品后平滑填补空隙并调整拾取窗口大小。"
L["Reset Loot Window Position"] = "重置拾取窗口位置"
L["Clear the saved position. The Blizzard default will be used next time you open the loot window."] = "清除保存的位置。下次打开拾取窗口时将使用暴雪默认位置。"
...
L["Aura Borders"] = "光环边框"
L["Enable Aura Borders"] = "启用光环边框"
L["Show modern borders around buff and debuff icons."] = "在增益和减益图标周围显示现代风格边框。"
L["Buff Border Color"] = "增益边框颜色"
L["Reset Debuff Position"] = "重置减益位置"
L["Debuff position reset."] = "已重置减益位置。"
L["Debuffs detached - positioned freely via Editor Mode"] = "减益已分离 — 可通过编辑模式自由摆放"
L["Debuffs attached - follow buff row"] = "减益已附着 — 跟随增益行"
L["Lock Toggle Hotkey"] = "锁定切换快捷键"
L["Choose the modifier + mouse button used to lock or unlock a bag slot while hovering it."] = "选择将鼠标悬停的背包格子锁定或解锁所用的组合键与鼠标按键。"
L["Use /sortlock to lock or unlock the currently hovered slot from chat."] = "可在聊天框使用 /sortlock 锁定或解锁当前悬停的格子。"
L["Reverse Stack Order"] = "反转堆叠顺序"
L["Stack sorted items from the end of each bag so empty slots stay at the top."] = "从每个背包的末尾开始堆放已排序物品，使空格留在顶部。"
L["Alt + Left Click"] = "Alt + 左键点击"
L["Ctrl + Left Click"] = "Ctrl + 左键点击"
L["Shift + Left Click"] = "Shift + 左键点击"
L["Alt + Right Click"] = "Alt + 右键点击"
L["Ctrl + Right Click"] = "Ctrl + 右键点击"
L["Shift + Right Click"] = "Shift + 右键点击"
L["Alt + Middle Click"] = "Alt + 中键点击"
L["Ctrl + Middle Click"] = "Ctrl + 中键点击"
L["Shift + Middle Click"] = "Shift + 中键点击"
L["Extra Bar Scale"] = "额外条缩放"
L["Bar"] = "条"
L["Hide the main bar while in combat."] = "战斗中隐藏主动作条。"
L["Fade the quest tracker until you hover over it."] = "在鼠标悬停之前淡出任务追踪器。"
L["Fade the quest tracker until you enter combat."] = "在进入战斗之前淡出任务追踪器。"
L["Hide the quest tracker while in combat."] = "战斗中隐藏任务追踪器。"
L["Fade the XP and Reputation bars until you hover over them."] = "在鼠标悬停之前淡出经验条与声望条。"
L["Fade the XP and Reputation bars until you enter combat."] = "在进入战斗之前淡出经验条与声望条。"
L["Hide the XP and Reputation bars while in combat."] = "战斗中隐藏经验条与声望条。"
L["Fade the player frame until you hover over it."] = "在鼠标悬停之前淡出玩家框体。"
L["Fade the player frame until you enter combat."] = "在进入战斗之前淡出玩家框体。"
L["Also fades the Target of Target and target cast bar, attached or not."] = "同时淡出目标的目标与目标施法条，无论是否附着。"
L["Fade the target frame group until you hover over it."] = "在鼠标悬停之前淡出目标框体组。"
L["Fade the target frame group until you enter combat."] = "在进入战斗之前淡出目标框体组。"
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "同时淡出焦点的目标与焦点施法条，无论是否附着。"
L["Fade the focus frame group until you hover over it."] = "在鼠标悬停之前淡出焦点框体组。"
L["Fade the focus frame group until you enter combat."] = "在进入战斗之前淡出焦点框体组。"
L["Fade the pet frame until you hover over it."] = "在鼠标悬停之前淡出宠物框体。"
L["Fade the pet frame until you enter combat."] = "在进入战斗之前淡出宠物框体。"
L["Fade party frames until you hover over them."] = "在鼠标悬停之前淡出队伍框体。"
L["Fade party frames until you enter combat."] = "在进入战斗之前淡出队伍框体。"
L["Fade boss frames until you hover over them."] = "在鼠标悬停之前淡出首领框体。"
L["Fade boss frames until you enter combat."] = "在进入战斗之前淡出首领框体。"
L["Boss"] = "首领"
L["Fade the stance bar until you hover over it."] = "在鼠标悬停之前淡出姿态条。"
L["Fade the stance bar until you enter combat."] = "在进入战斗之前淡出姿态条。"
L["Fade the pet bar until you hover over it."] = "在鼠标悬停之前淡出宠物条。"
L["Fade the pet bar until you enter combat."] = "在进入战斗之前淡出宠物条。"
L["Fade the totem bar until you hover over it."] = "在鼠标悬停之前淡出图腾条。"
L["Fade the totem bar until you enter combat."] = "在进入战斗之前淡出图腾条。"
L["Fade the minimap until you hover over it."] = "在鼠标悬停之前淡出小地图。"
L["Fade the minimap until you enter combat."] = "在进入战斗之前淡出小地图。"
L["Experimental:"] = "实验性："
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "淡出小地图偶尔会导致追踪图标在 /reload 之前停止更新。请自行斟酌使用。"
L["Has no effect while SexyMap controls the minimap (SexyMap or Hybrid mode)."] = "当 SexyMap 控制小地图时无效（SexyMap 或混合模式）。"
L["Hide in Combat"] = "战斗中隐藏"
L["Hide the minimap while in combat."] = "战斗中隐藏小地图。"
L["Modern Icon Border Desc"] = "使用 DragonUI 动作条边框而非经典圆环来包裹法术图标。"
L["Total icons in the row. Buffs and debuffs share these slots, lowest priority drops first."] = "该行的图标总数。增益与减益共用这些格子，优先级最低的先被舍弃。"
L["Lets stuns, fears and polymorphs from anyone through the Only My Debuffs filter. Enemy crowd control matters no matter who cast it."] = "允许任何人施放的昏迷、恐惧和变形穿过“仅我的减益”过滤。控制效果无论谁施放都很重要。"
L["Show buffs on enemy plates in the same row as debuffs. They compete for the same slots, ordered by priority."] = "在敌方名条上将增益与减益显示在同一行。它们争夺相同格子，按优先级排序。"
L["Purgeable shows what you can spellsteal or dispel, plus defensive cooldowns worth waiting out. No list to maintain."] = "“可驱散”会显示你能偷取或驱散的效果，以及值得等待的防御性冷却。无需维护列表。"
L["Only My Buffs"] = "仅我的增益"
L["Only show buffs you applied yourself."] = "只显示你自己施加的增益。"
L["Priority"] = "优先级"
L["Sort Order"] = "排序方式"
L["Priority puts your crowd control first, then anyone's crowd control, enemy defensives, your debuffs and the rest. Chronological sorts by time left only."] = "“优先级”会先排你的控制效果，然后是任何人的控制、敌方防御、你的减益及其余。“按时间”仅按剩余时间排序。"
L["Scale Icons by Priority"] = "按优先级缩放图标"
L["Draws higher-priority auras larger. Icons stay bottom-aligned, so the big ones grow upward without shifting the row."] = "将优先级更高的光环画得更大。图标保持底部对齐，因此大图标向上生长而不会挤动整行。"
L["Tints the icon frame by category: crowd control, enemy defensives, purgeable buffs, and dispel type for everything else."] = "按类别为图标边框着色：控制效果、敌方防御、可驱散增益，其余按驱散类型着色。"
L["Color by Dispel Type"] = "按驱散类型着色"
L["Show All Debuffs on Allies"] = "显示友方的所有减益"
L["Decides which icons come first, and which drop off when there is no room. Importance puts crowd control first, then enemy defensives, then your own debuffs."] = "决定哪些图标排在前面，以及空间不足时哪些被舍弃。“重要性”优先控制效果，其次敌方防御，再次你自己的减益。"
L["Extra Crowd Control Spells"] = "额外控制法术"
L["Show stuns, fears and polymorphs on allies even when they are not in the list."] = "即使不在列表中，也在友方身上显示昏迷、恐惧和变形。"
L["An ally in a raid carries dozens of auras, so nothing is shown unless you ask for it below."] = "团队中的友方身上会有数十个光环，因此除非你在下方指定，否则不显示任何内容。"
L["Highlighted auras draw larger than the rest. Everything else uses the base icon size."] = "被强调的光环会画得比其余更大。其余使用基础图标尺寸。"
L["Same rule as the Blizzard target frame: each debuff takes the colour of its dispel type, and one without a type uses None."] = "与暴雪目标框体规则相同：每个减益采用其驱散类型的颜色，没有类型的使用“无”。"
L["Crowd control uses its own colour instead of its dispel type."] = "控制效果使用自己的颜色，而非驱散类型颜色。"
L["Order: your crowd control, others' crowd control, enemy defensives, your debuffs, purgeable buffs, others' debuffs."] = "顺序：你的控制、他人的控制、敌方防御、你的减益、可驱散增益、他人的减益。"
L["Higher priority draws larger."] = "优先级越高画得越大。"
L["Tint the icon frame by category."] = "按类别为图标边框着色。"
L["Enemy Defensives"] = "敌方防御"
L["Purgeable"] = "可驱散"
L["Everything else uses its Magic, Curse, Disease or Poison color."] = "其余使用其魔法、诅咒、疾病或中毒对应的颜色。"
L["Purgeable means Magic or Enrage, plus the defensive list below."] = "“可驱散”指魔法或激怒，外加下方的防御列表。"
L["Categories"] = "类别"
L["These lists decide which auras count as defensive or as crowd control, for both sorting and border color."] = "这些列表决定哪些光环算作防御或控制，同时影响排序与边框颜色。"
L["Extra Crowd Control"] = "额外控制效果"
L["Added on top of the built-in crowd control list."] = "在内置控制效果列表之上追加。"
L["Only the spells listed below are shown, never anything else."] = "只显示下方列出的法术，绝不显示其他内容。"
L["Show auras on friendly nameplates. Only the spells listed below are ever shown: an ally in a raid carries dozens and any other rule fills the screen."] = "在友方名条上显示光环。只会显示下方列出的法术：团队中的友方身上有数十个光环，任何其他规则都会塞满屏幕。"
L["Tints plain debuffs by their dispel type (Magic, Curse, Disease, Poison). Crowd control and defensives keep their own color."] = "按驱散类型（魔法、诅咒、疾病、中毒）为普通减益着色。控制效果与防御效果保留自己的颜色。"
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "利用战斗记录推测你未选中单位的施法。比上方的目标、焦点、鼠标悬停和竞技场敌人准确度更低。"
L["Sync From Native Cast Bar"] = "与原生施法条同步"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "在受支持的客户端上使用游戏内置的名条施法条以获得更准确的时间。可以放心保持启用。"
L["Native Progress Sync for Off-Target Casts"] = "非目标施法的原生进度同步"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "在可用时，基于战斗记录的非目标施法条会从暴雪原生施法条同步进度。"
L["showVKeyCastbar Mode"] = "showVKeyCastbar 模式"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto：保留客户端数值。force_on/off：名条模块启用期间由 DragonUI 设置 showVKeyCastbar。"
L["Auto (Do Not Force)"] = "自动（不强制）"
L["Force On"] = "强制开启"
L["Force Off"] = "强制关闭"
L["Quest"] = "任务"
L["Quest Icons"] = "任务图标"
L["Show Quest Icons"] = "显示任务图标"
L["Show kill/loot icons over your quest-objective mobs. Without awesome_wotlk, only your target, mouseover and focus show them."] = "在任务目标怪物头顶显示击杀/拾取图标。没有 awesome_wotlk 时，只有目标、鼠标悬停和焦点会显示。"
L["Pointer Mode"] = "指针模式"
L["Show a single quest marker on any objective mob instead of separate kill/loot icons."] = "在任何目标怪物上显示单一任务标记，而非分开的击杀/拾取图标。"
L["Kill Icon"] = "击杀图标"
L["Choose the icon shown for kill objectives."] = "选择用于击杀目标的图标。"
L["Sword"] = "剑"
L["Skull"] = "骷髅"
L["Elite"] = "精英"
L["Elite Kill Icon"] = "精英击杀图标"
L["Show a distinct icon on elite and rare kill objectives."] = "为精英和稀有击杀目标显示不同的图标。"
L["Loot Icon"] = "拾取图标"
L["Choose the icon shown for loot/collect objectives."] = "选择用于拾取/收集目标的图标。"
L["Bag"] = "背包"
L["Chest"] = "宝箱"
L["Pointer"] = "指针"
L["Pointer Icon"] = "指针图标"
...
L["Set which stat and which combat panel lead the list:"] = "选择哪项属性和哪个战斗面板排在列表最前:"
L["Highlight Main Stat"] = "高亮主属性"
L["The attribute your class is built around."] = "你的职业所依赖的属性。"
L["Auto (by class)"] = "自动(按职业)"
L["Combat Statistics"] = "战斗数据"
L["Which one leads the list: Melee, Ranged, or Spell."] = "哪个排在列表最前:近战、远程或法术。"
...
L["Enable World Map"] = "启用世界地图"
L["Apply the DragonUI reskin to the world map."] = "将 DragonUI 外观应用到世界地图。"
L["Show Undiscovered Areas"] = "显示未探索区域"
L["Draw the map art of areas you have not explored yet, dimmed."] = "以暗色绘制尚未探索区域的地图图像。"
L["Show Landmarks"] = "显示地标"
L["Show Map Coordinates"] = "显示地图坐标"
L["Show your coordinates and the cursor's in the corner of the map."] = "在地图角落显示你的坐标和光标坐标。"
L["Show Zone Levels"] = "显示区域等级"
L["Show the recommended level range next to zone names and instance pins."] = "在区域名称和地下城标记旁显示推荐等级范围。"
L["Fade Map While Moving"] = "移动时淡化地图"
L["Dim the map while you move, unless the cursor is over it."] = "移动时淡化地图，除非光标停留在地图上。"
L["Moving Map Alpha"] = "移动时透明度"
L["How visible the map stays while you move."] = "移动时地图保持的可见度。"
L["Show towns, flight points and other landmark pins on the map."] = "在地图上显示城镇、飞行点和其他地标。"
L["Show Dungeon Entrances"] = "显示地下城入口"
L["Show dungeon and raid entrance pins on zone maps."] = "在区域地图上显示地下城和团队副本入口。"
L["Show Graveyards"] = "显示墓地"
...
-- Talents
L["Talents"] = "天赋"
L["Retail-style talent window"] = "正式服风格天赋窗口"
L["Enable Talent Window"] = "启用天赋窗口"
L["Replace Blizzard's talent and glyph window."] = "替换暴雪的天赋和雕文窗口。"
L["Size of the talent window on top of your UI scale; 1.0 matches the other panels. It never grows past the screen."] = "天赋窗口在界面缩放之上的大小；1.0 与其他面板相同。窗口不会超出屏幕。"
