...
L["Keep the micro menu permanently hidden, overriding hover and combat settings below."] = true
L["Keep the bag bar permanently hidden, overriding hover and combat settings below."] = true
