...
L["Opacity of tabs, buttons and chat background when not hovered. 0 = hidden, 1 = always visible."] = "Opacidad de pestañas, botones y fondo del chat cuando el mouse no está encima. 0 = oculto, 1 = siempre visible."
L["Equipment"] = "Equipo"
L["Usable"] = "Utilizable"
...
L["Fade the quest tracker until you hover over it."] = "Atenúa el rastreador de misiones hasta que pases el mouse por encima."
...
L["Fade the XP and Reputation bars until you hover over them."] = "Atenúa las barras de experiencia y reputación hasta que pases el mouse por encima."
...
L["Fade the player frame until you hover over it."] = "Atenúa el marco del jugador hasta que pases el mouse por encima."
...
L["Fade the target frame group until you hover over it."] = "Atenúa el grupo de marcos del objetivo hasta que pases el mouse por encima."
...
L["Fade the focus frame group until you hover over it."] = "Atenúa el grupo de marcos del foco hasta que pases el mouse por encima."
L["Fade the focus frame group until you enter combat."] = "Atenúa el grupo de marcos del foco hasta que entres en combate."
L["Fade the pet frame until you hover over it."] = "Atenúa el marco de la mascota hasta que pases el mouse por encima."
L["Fade the pet frame until you enter combat."] = "Atenúa el marco de la mascota hasta que entres en combate."
L["Fade party frames until you hover over them."] = "Atenúa los marcos de grupo hasta que pases el mouse por encima."
L["Fade party frames until you enter combat."] = "Atenúa los marcos de grupo hasta que entres en combate."
L["Fade boss frames until you hover over them."] = "Atenúa los marcos de jefe hasta que pases el mouse por encima."
L["Fade boss frames until you enter combat."] = "Atenúa los marcos de jefe hasta que entres en combate."
L["Boss"] = "Jefe"
L["Fade the stance bar until you hover over it."] = "Atenúa la barra de posturas hasta que pases el mouse por encima."
L["Fade the stance bar until you enter combat."] = "Atenúa la barra de posturas hasta que entres en combate."
L["Fade the pet bar until you hover over it."] = "Atenúa la barra de mascota hasta que pases el mouse por encima."
L["Fade the pet bar until you enter combat."] = "Atenúa la barra de mascota hasta que entres en combate."
L["Fade the totem bar until you hover over it."] = "Atenúa la barra de tótems hasta que pases el mouse por encima."
L["Fade the totem bar until you enter combat."] = "Atenúa la barra de tótems hasta que entres en combate."
L["Fade the minimap until you hover over it."] = "Atenúa el minimapa hasta que pases el mouse por encima."
...
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "Usa el registro de combate para deducir lanzamientos de unidades que no tienes seleccionadas. Es menos preciso que objetivo, foco, ratón encima y enemigos de arena de arriba."
...
L["Show kill/loot icons over your quest-objective mobs. Without awesome_wotlk, only your target, mouseover and focus show them."] = "Muestra iconos de matar/saquear sobre las criaturas de tus objetivos de misión. Sin awesome_wotlk solo aparecen en tu objetivo, mouse encima y foco."
...
L["Keep boss nameplates visible at the top of the screen inside party and raid instances."] = "Mantiene visibles las placas de jefe (calavera / ??) en pantalla."
L["Scales the nameplate clickbox relative to its original size. Recommended to change this setting while out of combat."] = "Escala el área de clic de la placa respecto a su tamaño original. Se recomienda cambiar este ajuste fuera de combate."
...
L["Show the average item level of your equipped gear."] = "Muestra el nivel de objeto promedio de tu equipo."
