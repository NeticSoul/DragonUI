...
L["Player Aura Spacing"] = "Espaciado de Auras del Jugador"
...
L["Grays the health bar when a unit is tapped by another player or group. Remembers tap status after you mouse away or change target."] = "Pone la barra de vida en gris cuando una unidad está tagueada por otro jugador o grupo. Recuerda el estado tras quitar el ratón o cambiar de objetivo."
