...
L["Grays the health bar when a unit is tapped by another player or group. Remembers tap status after you mouse away or change target."] = "다른 플레이어나 파티가 선점한 대상의 생명력 바를 회색으로 표시합니다. 마우스를 떼거나 대상을 바꿔도 상태를 기억합니다."
