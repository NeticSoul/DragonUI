...
L["Positions"] = "위치"
L["Player Aura Spacing"] = "플레이어 오라 간격"
...
L["Enable this if you use an external nameplate addon (PlateBuffs, Icicle, ...) that isn't detecting DragonUI's nameplates correctly."] = "PlateBuffs, Icicle 등 DragonUI의 네임플레이트를 제대로 인식하지 못하는 외부 네임플레이트 addon을 사용 중이라면 이 옵션을 활성화하세요."
