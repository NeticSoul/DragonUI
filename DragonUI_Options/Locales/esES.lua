...
L["Enable this if you use an external nameplate addon (PlateBuffs, Icicle, ...) that isn't detecting DragonUI's nameplates correctly."] = "Actívalo si usas un addon externo de placas de nombre (PlateBuffs, Icicle, ...) que no detecta correctamente las placas de DragonUI."
