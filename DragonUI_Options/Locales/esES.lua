...
L["Font size of the health text inside the bar (1-10). After the name it uses the name's font size."] = "Tamaño de fuente del texto de vida dentro de la barra (1-10). Junto al nombre usa el tamaño del nombre."
...
L["The Modern style draws the name and health text like NewEra: Friz Quadrata at retail's size, outlined inside the bar."] = "El estilo Moderno dibuja el nombre y el texto de vida como NewEra: Friz Quadrata al tamaño de retail, con contorno dentro de la barra."
L["The Modern style sizes the spell name like NewEra."] = "El estilo Moderno ajusta el tamaño del nombre del hechizo como NewEra."
L["The Modern style sizes the timer and stack count to each icon, like NewEra."] = "El estilo Moderno ajusta el temporizador y las cargas al tamaño de cada icono, como NewEra."
