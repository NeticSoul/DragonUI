...
L["Show your class icon in the portrait instead of your character's face."] = "Muestra el icono de tu clase en el retrato en vez de la cara de tu personaje."
L["Class-Colored Level Text"] = "Texto de nivel con color de clase"
L["Color the class name in the \"Level X Race Class\" line."] = "Colorea el nombre de la clase en la línea \"Nivel X Raza Clase\"."
...
L["New characters will use this profile."] = "Los personajes nuevos usarán este perfil."
L["New characters will get their own profile."] = "Los personajes nuevos tendrán su propio perfil."
L["New characters will start on profile: "] = "Los personajes nuevos empezarán con el perfil: "
...
L["What the health text shows. With both, the value comes first."] = "Qué muestra el texto de vida. Con ambos, primero va el valor."
L["Percent"] = "Porcentaje"
L["Value"] = "Valor"
L["Value and Percent"] = "Valor y porcentaje"
L["After the name, the name is shortened so the two never overlap. With the name inside the health bar, the text always sits at the bar's right end."] = "Junto al nombre, el nombre se acorta para que nunca se solapen. Con el nombre dentro de la barra de vida, el texto va siempre en el extremo derecho de la barra."
L["After the Name"] = "Junto al nombre"
L["Inside the Bar, Centered"] = "Dentro de la barra, centrado"
L["Inside the Bar, Right"] = "Dentro de la barra, a la derecha"
L["Inside the Bar, Value Left and Percent Right"] = "Dentro de la barra, valor a la izquierda y % a la derecha"
L["Center Name"] = "Centrar nombre"
L["Center the name in the space the health text leaves free."] = "Centra el nombre en el espacio que deja libre el texto de vida."
L["Font size of the name, and of the health text when it follows the name (1-10, default 2)."] = "Tamaño de fuente del nombre y del texto de vida cuando va junto al nombre (1-10, por defecto 2)."
L["Inset the name, level, and health text from the left and right edges of the health bar. Does not affect the elite icon."] = "Separa el nombre, el nivel y el texto de vida de los bordes izquierdo y derecho de la barra de vida. No afecta al icono de élite."
L["Show"] = "Mostrar"
L["Always (anyone's)"] = "Siempre (de cualquiera)"
L["Follow 'Only My Debuffs'"] = "Según «Solo mis debuffs»"
L["Only Mine"] = "Solo míos"
L["Each listed spell can decide whose casts it shows, whatever 'Only My Debuffs' says."] = "Cada hechizo de la lista decide de quién se muestra, diga lo que diga «Solo mis debuffs»."
L["Click an entry to select it."] = "Haz clic en una entrada para seleccionarla."
L["Click to select."] = "Clic para seleccionar."
L["Remove Spell"] = "Quitar hechizo"
L["Select a spell above to choose whose casts it shows."] = "Selecciona un hechizo de la lista para elegir de quién se muestra."
L["Name & Health"] = "Nombre y vida"
L["Name"] = "Nombre"
L["Level"] = "Nivel"
L["Name Position"] = "Posición del nombre"
L["Above the Health Bar"] = "Encima de la barra de vida"
L["Inside the Health Bar"] = "Dentro de la barra de vida"
L["Moves the name up or down while it sits inside the health bar."] = "Sube o baja el nombre cuando va dentro de la barra de vida."
L["The name is inside the health bar, so the health text sits at the bar's right end, after the name."] = "El nombre va dentro de la barra de vida, así que el texto de vida se coloca en el extremo derecho de la barra, tras el nombre."
L["The Modern style draws its own bar background."] = "El estilo Moderno dibuja su propio fondo de barra."
L["Name Text"] = "Texto del nombre"
L["Color friendly player names by class. Needs Party Class Colors or Friendly Class Colors."] = "Colorea por clase los nombres de jugadores aliados. Requiere «Colores de clase en grupo» o «Colores de clase aliados»."
L["Color enemy player names by class. Needs Enemy Player Class Colors."] = "Colorea por clase los nombres de jugadores enemigos. Requiere «Colores de clase de jugadores enemigos»."
L["Font size of the health text inside the bar (1-10). After the name, or in the Modern style, it matches the name."] = "Tamaño de fuente del texto de vida dentro de la barra (1-10). Junto al nombre, o en el estilo Moderno, usa el tamaño del nombre."
L["Text Outline"] = "Contorno del texto"
L["Black outline on the name and health text."] = "Contorno negro en el nombre y el texto de vida."
...
L["Enable Aura Borders"] = "Activar bordes de auras"
L["Show modern borders around buff and debuff icons."] = "Muestra bordes modernos alrededor de los iconos de beneficios y perjuicios."
L["Buff Border Color"] = "Color del borde de beneficios"
L["Reset Debuff Position"] = "Restablecer posición de perjuicios"
L["Debuff position reset."] = "Posición de perjuicios restablecida."
L["Debuffs detached - positioned freely via Editor Mode"] = "Perjuicios desacoplados: se colocan libremente con el modo editor"
L["Debuffs attached - follow buff row"] = "Perjuicios acoplados: siguen la fila de beneficios"
L["Opacity of tabs, buttons and chat background when not hovered. 0 = hidden, 1 = always visible."] = "Opacidad de pestañas, botones y fondo del chat cuando el ratón no está encima. 0 = oculto, 1 = siempre visible."
L["Equipment"] = "Equipo"
L["Usable"] = "Utilizable"
L["Extra Bar Scale"] = "Escala de la barra extra"
L["Bar"] = "Barra"
L["Hide the main bar while in combat."] = "Oculta la barra principal durante el combate."
L["Fade the quest tracker until you hover over it."] = "Atenúa el rastreador de misiones hasta que pases el ratón por encima."
L["Fade the quest tracker until you enter combat."] = "Atenúa el rastreador de misiones hasta que entres en combate."
L["Hide the quest tracker while in combat."] = "Oculta el rastreador de misiones durante el combate."
L["Fade the XP and Reputation bars until you hover over them."] = "Atenúa las barras de experiencia y reputación hasta que pases el ratón por encima."
L["Fade the XP and Reputation bars until you enter combat."] = "Atenúa las barras de experiencia y reputación hasta que entres en combate."
L["Hide the XP and Reputation bars while in combat."] = "Oculta las barras de experiencia y reputación durante el combate."
L["Fade the player frame until you hover over it."] = "Atenúa el marco del jugador hasta que pases el ratón por encima."
L["Fade the player frame until you enter combat."] = "Atenúa el marco del jugador hasta que entres en combate."
L["Also fades the Target of Target and target cast bar, attached or not."] = "También atenúa el objetivo del objetivo y la barra de lanzamiento del objetivo, esté acoplada o no."
L["Fade the target frame group until you hover over it."] = "Atenúa el grupo de marcos del objetivo hasta que pases el ratón por encima."
L["Fade the target frame group until you enter combat."] = "Atenúa el grupo de marcos del objetivo hasta que entres en combate."
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "También atenúa el objetivo del foco y la barra de lanzamiento del foco, esté acoplada o no."
L["Fade the focus frame group until you hover over it."] = "Atenúa el grupo de marcos del foco hasta que pases el ratón por encima."
L["Fade the focus frame group until you enter combat."] = "Atenúa el grupo de marcos del foco hasta que entres en combate."
L["Fade the pet frame until you hover over it."] = "Atenúa el marco de la mascota hasta que pases el ratón por encima."
L["Fade the pet frame until you enter combat."] = "Atenúa el marco de la mascota hasta que entres en combate."
L["Fade party frames until you hover over them."] = "Atenúa los marcos de grupo hasta que pases el ratón por encima."
L["Fade party frames until you enter combat."] = "Atenúa los marcos de grupo hasta que entres en combate."
L["Fade boss frames until you hover over them."] = "Atenúa los marcos de jefe hasta que pases el ratón por encima."
L["Fade boss frames until you enter combat."] = "Atenúa los marcos de jefe hasta que entres en combate."
L["Boss"] = "Jefe"
L["Fade the stance bar until you hover over it."] = "Atenúa la barra de posturas hasta que pases el ratón por encima."
L["Fade the stance bar until you enter combat."] = "Atenúa la barra de posturas hasta que entres en combate."
L["Fade the pet bar until you hover over it."] = "Atenúa la barra de mascota hasta que pases el ratón por encima."
L["Fade the pet bar until you enter combat."] = "Atenúa la barra de mascota hasta que entres en combate."
L["Fade the totem bar until you hover over it."] = "Atenúa la barra de tótems hasta que pases el ratón por encima."
L["Fade the totem bar until you enter combat."] = "Atenúa la barra de tótems hasta que entres en combate."
L["Fade the minimap until you hover over it."] = "Atenúa el minimapa hasta que pases el ratón por encima."
L["Fade the minimap until you enter combat."] = "Atenúa el minimapa hasta que entres en combate."
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "Atenuar el minimapa puede hacer que los iconos de rastreo dejen de actualizarse hasta que uses /reload. Úsalo bajo tu propia responsabilidad."
L["Has no effect while SexyMap controls the minimap (SexyMap or Hybrid mode)."] = "No tiene efecto mientras SexyMap controla el minimapa (modo SexyMap o híbrido)."
L["Hide in Combat"] = "Ocultar en combate"
L["Hide the minimap while in combat."] = "Oculta el minimapa durante el combate."
L["Sync From Native Cast Bar"] = "Sincronizar con la barra de lanzamiento nativa"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "En clientes compatibles, usa la barra de lanzamiento nativa de las placas para un mejor sincronismo. Es seguro dejarlo activado."
L["Native Progress Sync for Off-Target Casts"] = "Sincronización nativa del progreso para lanzamientos fuera del objetivo"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "Cuando está disponible, las barras de lanzamiento fuera del objetivo sincronizan su progreso con la barra nativa de Blizzard."
L["showVKeyCastbar Mode"] = "Modo showVKeyCastbar"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto: mantiene el valor del cliente. force_on/off: DragonUI ajusta showVKeyCastbar mientras el módulo de placas está activo."
L["Auto (Do Not Force)"] = "Automático (no forzar)"
L["Force On"] = "Forzar activado"
L["Force Off"] = "Forzar desactivado"
L["Quest"] = "Misión"
L["Quest Icons"] = "Iconos de misión"
L["Show Quest Icons"] = "Mostrar iconos de misión"
L["Show kill/loot icons over your quest-objective mobs. Without awesome_wotlk, only your target, mouseover and focus show them."] = "Muestra iconos de matar/saquear sobre las criaturas de tus objetivos de misión. Sin awesome_wotlk solo aparecen en tu objetivo, ratón encima y foco."
L["Pointer Mode"] = "Modo puntero"
L["Show a single quest marker on any objective mob instead of separate kill/loot icons."] = "Muestra un único marcador de misión en cualquier criatura objetivo en lugar de iconos separados de matar/saquear."
L["Kill Icon"] = "Icono de matar"
L["Choose the icon shown for kill objectives."] = "Elige el icono que se muestra en los objetivos de matar."
L["Sword"] = "Espada"
L["Skull"] = "Calavera"
L["Elite"] = "Élite"
L["Elite Kill Icon"] = "Icono de matar élite"
L["Show a distinct icon on elite and rare kill objectives."] = "Muestra un icono distinto en los objetivos de matar de élite y raros."
L["Loot Icon"] = "Icono de saqueo"
L["Choose the icon shown for loot/collect objectives."] = "Elige el icono que se muestra en los objetivos de saqueo y recolección."
L["Bag"] = "Bolsa"
L["Chest"] = "Cofre"
L["Pointer"] = "Puntero"
L["Pointer Icon"] = "Icono de puntero"
L["Off"] = "Desactivado"
L["Size"] = "Tamaño"
L["Icon"] = "Icono"
L["Test Preview"] = "Vista previa de prueba"
L["Preview Icon"] = "Icono de vista previa"
L["Force one icon on all enemy nameplates so you can position and size it. Set to Off when done."] = "Fuerza un icono en todas las placas enemigas para que puedas ajustar su posición y tamaño. Ponlo en Desactivado al terminar."
...
L["DragonUI-style health bars on Blizzard nameplates (30300)."] = "Barras de vida al estilo DragonUI sobre las placas de nombre de Blizzard (30300)."
L["Plate Style"] = "Estilo de placa"
L["Nameplate Art"] = "Arte de las placas"
L["Heritage is the DragonUI art. Modern draws the current World of Warcraft nameplate chrome and is still in beta."] = "Clásico es el arte de DragonUI. Moderno dibuja el marco actual de las placas de World of Warcraft y sigue en beta."
L["Modern (Beta)"] = "Moderno (Beta)"
L["Heritage"] = "Clásico"
L["Mouseover Highlight"] = "Resaltado al pasar el cursor"
L["Wash the health bar with a bright overlay while the cursor is over the nameplate."] = "Aclara la barra de vida mientras el cursor está sobre la placa."
L["Target Selection Border"] = "Borde del objetivo seleccionado"
L["Draw the white glowing border around the current target's health bar."] = "Dibuja el borde blanco brillante alrededor de la barra de vida del objetivo actual."
L["Dim Non-Target Plates"] = "Atenuar placas que no son el objetivo"
L["Lay the retail dim overlay over every nameplate that is not your target."] = "Pone el velo oscuro de retail sobre cada placa que no sea tu objetivo."
L["Retail Threat Colors"] = "Colores de amenaza de retail"
L["Use retail's yellow and orange threat steps instead of the yellow, orange and red set."] = "Usa los pasos de amenaza amarillo y naranja de retail en lugar del juego amarillo, naranja y rojo."
L["Show Level in Name"] = "Mostrar nivel en el nombre"
L["Bar Size"] = "Tamaño de la barra"
L["Width of the nameplate health bar."] = "Anchura de la barra de vida de la placa."
L["Height of the nameplate health bar."] = "Altura de la barra de vida de la placa."
L["Name and health percent font scale (1-10)."] = "Escala de fuente del nombre y del porcentaje de vida (1-10)."
L["Stack Offset X"] = "Desplazamiento X del apilado"
L["Horizontal offset for the nameplate stack."] = "Desplazamiento horizontal del apilado de placas."
L["Stack Offset Y"] = "Desplazamiento Y del apilado"
L["Vertical offset for the nameplate stack."] = "Desplazamiento vertical del apilado de placas."
L["Highlight texture on the targeted nameplate."] = "Textura de resalte en la placa del objetivo."
L["Opacity for non-target nameplates when fade is enabled (0.0-1.0)."] = "Opacidad de las placas que no son tu objetivo cuando la atenuación está activada (0.0-1.0)."
L["Hide mana/power on NPC nameplates when unit is known."] = "Oculta el maná o poder en las placas de PNJ cuando la unidad es conocida."
L["On 3.3.5a, enemy cast bars appear on the targeted plate only."] = "En 3.3.5a, las barras de lanzamiento enemigas solo aparecen en la placa del objetivo."
L["Side arrows on the targeted nameplate."] = "Flechas laterales en la placa del objetivo."
L["Behavior Mode"] = "Modo de comportamiento"

-- Character Panel, Pets & Mounts and diagnostics
L["Experimental:"] = "Experimental:"

-- Character Panel, Pets & Mounts and diagnostics
L["Auto-show bars: Stance (Warriors/Druids/DKs) \226\128\162 Pet (Hunters/Warlocks/DKs) \226\128\162 Vehicle (All classes) \226\128\162 Totem (Shamans)"] = "Mostrar barras automáticamente: Actitud (Guerreros/Druidas/CM) • Mascota (Cazadores/Brujos/CM) • Vehículo (todas las clases) • Tótem (Chamanes)"
L["Visual enhancements that add Dragonflight-style polish to the UI. These are optional \226\128\148 disable any you don't want."] = "Mejoras visuales que dan a la interfaz el acabado de Dragonflight. Son opcionales — desactiva las que no quieras."
L["Detached \226\128\148 positioned freely via Editor Mode"] = "Separada — se coloca libremente con el modo editor"
...
L["Set which stat and which combat panel lead the list:"] = "Elige qué estadística y qué panel de combate encabezan la lista:"
L["Highlight Main Stat"] = "Resaltar estadística principal"
L["The attribute your class is built around."] = "La estadística en la que se basa tu clase."
L["Auto (by class)"] = "Automático (según clase)"
L["Combat Statistics"] = "Estadísticas de combate"
L["Which one leads the list: Melee, Ranged, or Spell."] = "Cuál encabeza la lista: cuerpo a cuerpo, distancia o hechizos."
...
L["Apply the DragonUI reskin to the world map."] = "Aplica el aspecto de DragonUI al mapa del mundo."
L["Show Undiscovered Areas"] = "Mostrar zonas sin descubrir"
L["Draw the map art of areas you have not explored yet, dimmed."] = "Dibuja atenuado el arte de las zonas que aún no has explorado."
L["Show Landmarks"] = "Mostrar puntos de interés"
L["Show Map Coordinates"] = "Mostrar coordenadas del mapa"
L["Show your coordinates and the cursor's in the corner of the map."] = "Muestra tus coordenadas y las del cursor en la esquina del mapa."
L["Show Zone Levels"] = "Mostrar niveles de zona"
L["Show the recommended level range next to zone names and instance pins."] = "Muestra el rango de nivel recomendado junto a los nombres de zona y las mazmorras."
L["Fade Map While Moving"] = "Atenuar el mapa al moverse"
L["Dim the map while you move, unless the cursor is over it."] = "Atenúa el mapa mientras te mueves, salvo que el cursor esté encima."
L["Moving Map Alpha"] = "Transparencia al moverse"
L["How visible the map stays while you move."] = "Cuánto se ve el mapa mientras te mueves."
L["Show towns, flight points and other landmark pins on the map."] = "Muestra ciudades, puntos de vuelo y otros marcadores en el mapa."
L["Show Dungeon Entrances"] = "Mostrar entradas de mazmorras"
L["Show dungeon and raid entrance pins on zone maps."] = "Muestra las entradas de mazmorras y bandas en los mapas de zona."
...
L["Plays a sound and flashes the screen edges when your HP drops below the configured threshold."] = "Reproduce un sonido y parpadea los bordes de la pantalla cuando tu HP cae por debajo del umbral configurado."
...
L["Enable Talent Window"] = "Activar ventana de talentos"
L["Replace Blizzard's talent and glyph window."] = "Sustituye la ventana de talentos y glifos de Blizzard."
L["Size of the talent window on top of your UI scale; 1.0 matches the other panels. It never grows past the screen."] = "Tamaño de la ventana de talentos sobre tu escala de interfaz; 1.0 es el de los demás paneles. Nunca se sale de la pantalla."
