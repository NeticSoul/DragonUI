...
L["Enable this if you use an external nameplate addon (PlateBuffs, Icicle, ...) that isn't detecting DragonUI's nameplates correctly."] = "Включите, если используете внешний аддон плашек (PlateBuffs, Icicle и т.д.), который неправильно определяет плашки DragonUI."
