...
L["Show Link Tooltips on Hover"] = "Показывать подсказки ссылок при наведении"
L["Show tooltips for supported chat links without holding Alt."] = "Показывать подсказки поддерживаемых ссылок чата без удерживания клавиши Alt."
...
L["New characters will use this profile."] = "Новые персонажи будут использовать этот профиль."
L["New characters will get their own profile."] = "Новые персонажи получат собственный профиль."
L["New characters will start on profile: "] = "Новые персонажи начнут с профиля: "
...
L["Plate Style"] = "Стиль индикаторов"
L["Nameplate Art"] = "Оформление индикаторов"
L["Heritage is the DragonUI art. Modern draws the current World of Warcraft nameplate chrome and is still in beta."] = "Классический — оформление DragonUI. Современный рисует актуальную рамку индикаторов World of Warcraft и пока в бета-версии."
L["Modern (Beta)"] = "Современный (бета)"
L["Heritage"] = "Классический"
L["Mouseover Highlight"] = "Подсветка при наведении"
L["Wash the health bar with a bright overlay while the cursor is over the nameplate."] = "Осветляет полосу здоровья, пока курсор находится над индикатором."
L["Target Selection Border"] = "Рамка выбранной цели"
L["Draw the white glowing border around the current target's health bar."] = "Рисует белую светящуюся рамку вокруг полосы здоровья текущей цели."
L["Dim Non-Target Plates"] = "Затемнять индикаторы не-целей"
L["Lay the retail dim overlay over every nameplate that is not your target."] = "Накладывает затемнение из retail на каждый индикатор, который не является вашей целью."
L["Retail Threat Colors"] = "Цвета угрозы retail"
L["Use retail's yellow and orange threat steps instead of the yellow, orange and red set."] = "Использует жёлтую и оранжевую ступени угрозы из retail вместо набора жёлтый, оранжевый и красный."
...
L["Percent"] = "Процент"
L["Value"] = "Значение"
L["Value and Percent"] = "Значение и процент"
L["After the name, the name is shortened so the two never overlap. With the name inside the health bar, the text always sits at the bar's right end."] = "После имени: имя сокращается, чтобы они никогда не перекрывались. Если имя внутри полосы здоровья, текст всегда стоит у правого края полосы."
L["After the Name"] = "После имени"
L["Inside the Bar, Centered"] = "В полосе, по центру"
L["Inside the Bar, Right"] = "В полосе, справа"
L["Inside the Bar, Value Left and Percent Right"] = "В полосе, значение слева и процент справа"
L["Center Name"] = "Центрировать имя"
L["Center the name in the space the health text leaves free."] = "Центрирует имя в месте, которое оставляет текст здоровья."
L["Font size of the name, and of the health text when it follows the name (1-10, default 2)."] = "Размер шрифта имени и текста здоровья, когда он идёт после имени (1-10, по умолчанию 2)."
L["Inset the name, level, and health text from the left and right edges of the health bar. Does not affect the elite icon."] = "Отступ имени, уровня и текста здоровья от левого и правого краёв полосы здоровья. Не влияет на значок элиты."
L["Show"] = "Показывать"
L["Always (anyone's)"] = "Всегда (чьи угодно)"
L["Follow 'Only My Debuffs'"] = "Как «Только мои дебаффы»"
L["Only Mine"] = "Только мои"
L["Each listed spell can decide whose casts it shows, whatever 'Only My Debuffs' says."] = "Каждое заклинание в списке само решает, чьи наложения показывать, что бы ни было в «Только мои дебаффы»."
L["Click an entry to select it."] = "Нажмите на запись, чтобы выбрать её."
L["Click to select."] = "Нажмите, чтобы выбрать."
L["Remove Spell"] = "Удалить заклинание"
L["Select a spell above to choose whose casts it shows."] = "Выберите заклинание выше, чтобы указать, чьи наложения показывать."
L["Name & Health"] = "Имя и здоровье"
L["Name"] = "Имя"
L["Level"] = "Уровень"
L["Name Position"] = "Положение имени"
L["Above the Health Bar"] = "Над полосой здоровья"
L["Inside the Health Bar"] = "Внутри полосы здоровья"
L["Moves the name up or down while it sits inside the health bar."] = "Смещает имя вверх или вниз, пока оно внутри полосы здоровья."
L["The name is inside the health bar, so the health text sits at the bar's right end, after the name."] = "Имя внутри полосы здоровья, поэтому текст здоровья стоит у правого края полосы, после имени."
L["The Modern style draws its own bar background."] = "Современный стиль рисует собственный фон полосы."
L["Name Text"] = "Текст имени"
L["Color friendly player names by class. Needs Party Class Colors or Friendly Class Colors."] = "Окрашивает имена союзных игроков по классу. Нужны «Цвета классов в группе» или «Цвета классов союзников»."
L["Color enemy player names by class. Needs Enemy Player Class Colors."] = "Окрашивает имена вражеских игроков по классу. Нужны «Цвета класса врагов»."
...
L["Color the glow and health bar by threat status (orange = tanking, yellow = gaining or losing)."] = "Окрашивает свечение и полосу здоровья по уровню угрозы (оранжевый = удержание, жёлтый = набор или потеря)."
...
L["Enable Aura Borders"] = "Включить рамки аур"
L["Show modern borders around buff and debuff icons."] = "Показывать современные рамки вокруг значков усиливающих и ослабляющих эффектов."
L["Buff Border Color"] = "Цвет рамки усиливающих эффектов"
L["Reset Debuff Position"] = "Сбросить положение ослабляющих эффектов"
L["Debuff position reset."] = "Положение ослабляющих эффектов сброшено."
L["Debuffs detached - positioned freely via Editor Mode"] = "Ослабляющие эффекты откреплены — свободное размещение в режиме редактора"
L["Debuffs attached - follow buff row"] = "Ослабляющие эффекты закреплены — следуют за рядом усиливающих"
L["Opacity of tabs, buttons and chat background when not hovered. 0 = hidden, 1 = always visible."] = "Непрозрачность вкладок, кнопок и фона чата, пока курсор не наведён. 0 — скрыто, 1 — всегда видно."
L["Lock Toggle Hotkey"] = "Сочетание для блокировки"
L["Choose the modifier + mouse button used to lock or unlock a bag slot while hovering it."] = "Выберите модификатор и кнопку мыши для блокировки или разблокировки ячейки сумки под курсором."
L["Use /sortlock to lock or unlock the currently hovered slot from chat."] = "Команда /sortlock блокирует или разблокирует ячейку под курсором из чата."
L["Reverse Stack Order"] = "Обратный порядок укладки"
L["Stack sorted items from the end of each bag so empty slots stay at the top."] = "Складывать отсортированные предметы с конца каждой сумки, чтобы пустые ячейки оставались сверху."
L["Alt + Left Click"] = "Alt + левый щелчок"
L["Ctrl + Left Click"] = "Ctrl + левый щелчок"
L["Shift + Left Click"] = "Shift + левый щелчок"
L["Alt + Right Click"] = "Alt + правый щелчок"
L["Ctrl + Right Click"] = "Ctrl + правый щелчок"
L["Shift + Right Click"] = "Shift + правый щелчок"
L["Alt + Middle Click"] = "Alt + средний щелчок"
L["Ctrl + Middle Click"] = "Ctrl + средний щелчок"
L["Shift + Middle Click"] = "Shift + средний щелчок"
L["Equipment"] = "Снаряжение"
L["Usable"] = "Расходуемое"
L["Extra Bar Scale"] = "Масштаб дополнительной панели"
L["Bar"] = "Панель"
L["Hide the main bar while in combat."] = "Скрывать основную панель в бою."
L["Fade the quest tracker until you hover over it."] = "Скрывать отслеживание заданий, пока на него не наведён курсор."
L["Fade the quest tracker until you enter combat."] = "Скрывать отслеживание заданий, пока вы не вступите в бой."
L["Hide the quest tracker while in combat."] = "Скрывать отслеживание заданий в бою."
L["Fade the XP and Reputation bars until you hover over them."] = "Скрывать полосы опыта и репутации, пока на них не наведён курсор."
L["Fade the XP and Reputation bars until you enter combat."] = "Скрывать полосы опыта и репутации, пока вы не вступите в бой."
L["Hide the XP and Reputation bars while in combat."] = "Скрывать полосы опыта и репутации в бою."
L["Fade the player frame until you hover over it."] = "Скрывать рамку игрока, пока на неё не наведён курсор."
L["Fade the player frame until you enter combat."] = "Скрывать рамку игрока, пока вы не вступите в бой."
L["Also fades the Target of Target and target cast bar, attached or not."] = "Также скрывает цель цели и полосу заклинаний цели, прикреплённую или нет."
L["Fade the target frame group until you hover over it."] = "Скрывать группу рамок цели, пока на неё не наведён курсор."
L["Fade the target frame group until you enter combat."] = "Скрывать группу рамок цели, пока вы не вступите в бой."
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "Также скрывает цель фокуса и полосу заклинаний фокуса, прикреплённую или нет."
L["Fade the focus frame group until you hover over it."] = "Скрывать группу рамок фокуса, пока на неё не наведён курсор."
L["Fade the focus frame group until you enter combat."] = "Скрывать группу рамок фокуса, пока вы не вступите в бой."
L["Fade the pet frame until you hover over it."] = "Скрывать рамку питомца, пока на неё не наведён курсор."
L["Fade the pet frame until you enter combat."] = "Скрывать рамку питомца, пока вы не вступите в бой."
L["Fade party frames until you hover over them."] = "Скрывать рамки группы, пока на них не наведён курсор."
L["Fade party frames until you enter combat."] = "Скрывать рамки группы, пока вы не вступите в бой."
L["Fade boss frames until you hover over them."] = "Скрывать рамки боссов, пока на них не наведён курсор."
L["Fade boss frames until you enter combat."] = "Скрывать рамки боссов, пока вы не вступите в бой."
L["Boss"] = "Босс"
L["Fade the stance bar until you hover over it."] = "Скрывать панель стоек, пока на неё не наведён курсор."
L["Fade the stance bar until you enter combat."] = "Скрывать панель стоек, пока вы не вступите в бой."
L["Fade the pet bar until you hover over it."] = "Скрывать панель питомца, пока на неё не наведён курсор."
L["Fade the pet bar until you enter combat."] = "Скрывать панель питомца, пока вы не вступите в бой."
L["Fade the totem bar until you hover over it."] = "Скрывать панель тотемов, пока на неё не наведён курсор."
L["Fade the totem bar until you enter combat."] = "Скрывать панель тотемов, пока вы не вступите в бой."
L["Fade the minimap until you hover over it."] = "Скрывать миникарту, пока на неё не наведён курсор."
L["Fade the minimap until you enter combat."] = "Скрывать миникарту, пока вы не вступите в бой."
L["Experimental:"] = "Экспериментально:"
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "Плавное скрытие миникарты иногда приводит к тому, что значки слежения перестают обновляться до /reload. Используйте на свой риск."
L["Has no effect while SexyMap controls the minimap (SexyMap or Hybrid mode)."] = "Не действует, пока миникартой управляет SexyMap (режим SexyMap или гибридный)."
L["Hide in Combat"] = "Скрывать в бою"
L["Hide the minimap while in combat."] = "Скрывать миникарту в бою."
L["Modern Icon Border Desc"] = "Обрамляет значок заклинания рамкой панели действий DragonUI вместо классического кольца."
L["Total icons in the row. Buffs and debuffs share these slots, lowest priority drops first."] = "Всего значков в ряду. Усиливающие и ослабляющие эффекты делят эти места; первым отбрасывается наименее приоритетное."
L["Lets stuns, fears and polymorphs from anyone through the Only My Debuffs filter. Enemy crowd control matters no matter who cast it."] = "Пропускает оглушения, страх и превращения от любого игрока через фильтр «Только мои ослабляющие эффекты». Контроль важен независимо от того, кто его наложил."
L["Show buffs on enemy plates in the same row as debuffs. They compete for the same slots, ordered by priority."] = "Показывать усиливающие эффекты на индикаторах врагов в том же ряду, что и ослабляющие. Они занимают одни и те же места по приоритету."
L["Purgeable shows what you can spellsteal or dispel, plus defensive cooldowns worth waiting out. No list to maintain."] = "«Снимаемое» показывает то, что можно украсть или рассеять, а также защитные способности, которые стоит переждать. Список вести не нужно."
L["Only My Buffs"] = "Только мои усиливающие эффекты"
L["Only show buffs you applied yourself."] = "Показывать только наложенные вами усиливающие эффекты."
L["Priority"] = "Приоритет"
L["Sort Order"] = "Порядок сортировки"
L["Priority puts your crowd control first, then anyone's crowd control, enemy defensives, your debuffs and the rest. Chronological sorts by time left only."] = "«Приоритет» ставит сначала ваш контроль, затем чужой, защитные способности врага, ваши ослабляющие эффекты и остальное. «Хронологически» сортирует только по оставшемуся времени."
L["Scale Icons by Priority"] = "Размер значков по приоритету"
L["Draws higher-priority auras larger. Icons stay bottom-aligned, so the big ones grow upward without shifting the row."] = "Отрисовывает более приоритетные ауры крупнее. Значки выравниваются по нижнему краю, поэтому крупные растут вверх, не смещая ряд."
L["Tints the icon frame by category: crowd control, enemy defensives, purgeable buffs, and dispel type for everything else."] = "Окрашивает рамку значка по категории: контроль, защитные способности врага, снимаемые усиливающие эффекты и тип рассеивания для остального."
L["Color by Dispel Type"] = "Цвет по типу рассеивания"
L["Show All Debuffs on Allies"] = "Показывать все ослабляющие эффекты на союзниках"
L["Decides which icons come first, and which drop off when there is no room. Importance puts crowd control first, then enemy defensives, then your own debuffs."] = "Определяет, какие значки идут первыми и какие исчезают при нехватке места. «Важность» ставит вперёд контроль, затем защитные способности врага, затем ваши ослабляющие эффекты."
L["Extra Crowd Control Spells"] = "Дополнительные заклинания контроля"
L["Show stuns, fears and polymorphs on allies even when they are not in the list."] = "Показывать оглушения, страх и превращения на союзниках, даже если их нет в списке."
L["An ally in a raid carries dozens of auras, so nothing is shown unless you ask for it below."] = "На союзнике в рейде висят десятки аур, поэтому ничего не отображается, пока вы не укажете это ниже."
L["Highlighted auras draw larger than the rest. Everything else uses the base icon size."] = "Выделенные ауры отрисовываются крупнее остальных. Всё прочее использует базовый размер значка."
L["Same rule as the Blizzard target frame: each debuff takes the colour of its dispel type, and one without a type uses None."] = "То же правило, что и у стандартной рамки цели: каждый ослабляющий эффект получает цвет своего типа рассеивания, а без типа — «Нет»."
L["Crowd control uses its own colour instead of its dispel type."] = "Контроль использует собственный цвет вместо типа рассеивания."
L["Order: your crowd control, others' crowd control, enemy defensives, your debuffs, purgeable buffs, others' debuffs."] = "Порядок: ваш контроль, чужой контроль, защитные способности врага, ваши ослабляющие эффекты, снимаемые усиливающие эффекты, чужие ослабляющие эффекты."
L["Higher priority draws larger."] = "Более приоритетное отрисовывается крупнее."
L["Tint the icon frame by category."] = "Окрашивать рамку значка по категории."
L["Enemy Defensives"] = "Защитные способности врага"
L["Purgeable"] = "Снимаемое"
L["Everything else uses its Magic, Curse, Disease or Poison color."] = "Всё прочее использует цвет магии, проклятия, болезни или яда."
L["Purgeable means Magic or Enrage, plus the defensive list below."] = "«Снимаемое» — это магия или ярость, плюс список защитных способностей ниже."
L["Categories"] = "Категории"
L["These lists decide which auras count as defensive or as crowd control, for both sorting and border color."] = "Эти списки определяют, какие ауры считаются защитными или контролем — и для сортировки, и для цвета рамки."
L["Extra Crowd Control"] = "Дополнительный контроль"
L["Added on top of the built-in crowd control list."] = "Добавляется к встроенному списку контроля."
L["Only the spells listed below are shown, never anything else."] = "Отображаются только перечисленные ниже заклинания и ничего больше."
L["Show auras on friendly nameplates. Only the spells listed below are ever shown: an ally in a raid carries dozens and any other rule fills the screen."] = "Показывать ауры на индикаторах союзников. Отображаются только перечисленные ниже заклинания: на союзнике в рейде их десятки, и любое другое правило заполнит экран."
L["Tints plain debuffs by their dispel type (Magic, Curse, Disease, Poison). Crowd control and defensives keep their own color."] = "Окрашивает обычные ослабляющие эффекты по типу рассеивания (магия, проклятие, болезнь, яд). Контроль и защитные способности сохраняют свой цвет."
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "Использует боевой журнал, чтобы угадывать заклинания целей, которые вы не выбрали. Менее точно, чем цель, фокус, наведение и противники на арене выше."
L["Sync From Native Cast Bar"] = "Синхронизировать со встроенной полосой заклинаний"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "На поддерживаемых клиентах использует встроенную полосу заклинаний индикаторов для более точного тайминга. Можно смело оставить включённым."
L["Native Progress Sync for Off-Target Casts"] = "Встроенная синхронизация прогресса для заклинаний вне цели"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "Когда доступно, полосы заклинаний вне цели синхронизируют прогресс со встроенной полосой Blizzard."
L["showVKeyCastbar Mode"] = "Режим showVKeyCastbar"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto: сохранять значение клиента. force_on/off: DragonUI задаёт showVKeyCastbar, пока модуль индикаторов активен."
L["Auto (Do Not Force)"] = "Автоматически (не принудительно)"
L["Force On"] = "Принудительно включить"
L["Force Off"] = "Принудительно выключить"
L["Quest"] = "Задание"
L["Quest Icons"] = "Значки заданий"
L["Show Quest Icons"] = "Показывать значки заданий"
L["Show kill/loot icons over your quest-objective mobs. Without awesome_wotlk, only your target, mouseover and focus show them."] = "Показывать значки убийства и добычи над существами из ваших заданий. Без awesome_wotlk они видны только на цели, при наведении и на фокусе."
L["Pointer Mode"] = "Режим указателя"
L["Show a single quest marker on any objective mob instead of separate kill/loot icons."] = "Показывать одну метку задания на любом существе-цели вместо отдельных значков убийства и добычи."
L["Kill Icon"] = "Значок убийства"
L["Choose the icon shown for kill objectives."] = "Выберите значок для целей на убийство."
L["Sword"] = "Меч"
L["Skull"] = "Череп"
L["Elite"] = "Элитный"
L["Elite Kill Icon"] = "Значок убийства элитных"
L["Show a distinct icon on elite and rare kill objectives."] = "Показывать отдельный значок для элитных и редких целей на убийство."
L["Loot Icon"] = "Значок добычи"
L["Choose the icon shown for loot/collect objectives."] = "Выберите значок для целей на добычу и сбор."
L["Bag"] = "Сумка"
L["Chest"] = "Сундук"
L["Pointer"] = "Указатель"
L["Pointer Icon"] = "Значок указателя"
L["Off"] = "Выкл."
L["Size"] = "Размер"
L["Icon"] = "Значок"
L["Test Preview"] = "Тестовый просмотр"
...
L["Set which stat and which combat panel lead the list:"] = "Выберите, какая характеристика и какая боевая панель будут первыми в списке:"
L["Highlight Main Stat"] = "Подсветка основной характеристики"
L["The attribute your class is built around."] = "Характеристика, на которой основан ваш класс."
L["Auto (by class)"] = "Авто (по классу)"
L["Combat Statistics"] = "Боевые характеристики"
L["Which one leads the list: Melee, Ranged, or Spell."] = "Что возглавляет список: ближний бой, дальний бой или заклинания."
...
L["Apply the DragonUI reskin to the world map."] = "Применяет оформление DragonUI к карте мира."
L["Show Undiscovered Areas"] = "Показывать неисследованные области"
L["Draw the map art of areas you have not explored yet, dimmed."] = "Отображает приглушенную графику еще не исследованных областей."
L["Show Landmarks"] = "Показывать ориентиры"
L["Show Map Coordinates"] = "Показывать координаты карты"
L["Show your coordinates and the cursor's in the corner of the map."] = "Показывает ваши координаты и координаты курсора в углу карты."
L["Show Zone Levels"] = "Показывать уровни зон"
L["Show the recommended level range next to zone names and instance pins."] = "Показывает рекомендуемый диапазон уровней рядом с названиями зон и метками подземелий."
L["Fade Map While Moving"] = "Затемнять карту при движении"
L["Dim the map while you move, unless the cursor is over it."] = "Затемняет карту, пока вы двигаетесь, если курсор не находится над ней."
L["Moving Map Alpha"] = "Прозрачность при движении"
L["How visible the map stays while you move."] = "Насколько карта остается видимой, пока вы двигаетесь."
L["Show towns, flight points and other landmark pins on the map."] = "Показывает города, точки полета и другие ориентиры на карте."
L["Show Dungeon Entrances"] = "Показывать входы в подземелья"
L["Show dungeon and raid entrance pins on zone maps."] = "Показывает входы в подземелья и рейды на картах зон."
...
L["Plays a sound and flashes the screen edges when your HP drops below the configured threshold."] = "Играет звук и мигает краями экрана, когда ваш HP падает ниже настроенного порога."
L["Enable Low HP Alert"] = "Включить оповещение о низком HP"
L["Warning Sound (every 3 sec)"] = "Звук предупреждения (каждые 3 сек.)"
L["Plays a warning sound every 3 seconds while HP is below threshold."] = "Играет звук предупреждения каждые 3 секунды, пока HP ниже порога."
L["Screen Edge Flash"] = "Мигание краев экрана"
L["Flashes red at the edges of the screen while HP is below threshold."] = "Мигает красным по краям экрана, пока HP ниже порога."
L["Flash Color"] = "Цвет мигания"
L["Use Class Color"] = "Использовать цвет класса"
L["Use your class color (e.g. orange for Druid, yellow for Rogue) instead of the custom color."] = "Используйте цвет вашей класса (например, оранжевый для Друида, жёлтый для Разбойника) вместо пользовательского цвета."
L["Flash Opacity"] = "Непрозрачность мигания"
L["Maximum opacity of the flash effect."] = "Максимальная непрозрачность эффекта мигания."
L["Flash Extent"] = "Длина мигания"
L["How far the flash extends from the screen edges toward the center, in pixels."] = "Насколько далеко мигание распространяется от краёв экрана к центру, в пикселях."
...
L["Enable Talent Window"] = "Включить окно талантов"
L["Replace Blizzard's talent and glyph window."] = "Заменяет окно талантов и символов Blizzard."
L["Size of the talent window on top of your UI scale; 1.0 matches the other panels. It never grows past the screen."] = "Размер окна талантов поверх масштаба интерфейса; 1.0 — как у остальных панелей. Окно никогда не выходит за пределы экрана."
