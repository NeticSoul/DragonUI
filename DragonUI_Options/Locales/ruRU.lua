...
L["Positions"] = "Позиции"
L["Player Aura Spacing"] = "Отступы аур игрока"
...
L["Grays the health bar when a unit is tapped by another player or group. Remembers tap status after you mouse away or change target."] = "Делает полосу здоровья серой, если цель занята другим игроком или группой. Запоминает статус после увода курсора или смены цели."
